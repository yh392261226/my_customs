...
[[ -f $MYRUNTIME/customs/others/lincheney_fzf-tab-completion/bash/fzf-bash-completion.sh ]] && source $MYRUNTIME/customs/others/lincheney_fzf-tab-completion/bash/fzf-bash-completion.sh && bind -x '"\t": fzf_bash_completion'
