...
#Editor
#----------------------------------------------------------------------------------------------------------------
[ -f /opt/homebrew/opt/macvim/bin/mvim ]; and alias vim "/opt/homebrew/opt/macvim/bin/mvim -v"                   # Desc: alias: vim:(M1)设置环境变量为/opt/homebrew/opt/macvim/bin/mvim -v
[ -f /usr/local/opt/macvim/bin/mvim ]; and alias vim "/usr/local/opt/macvim/bin/mvim -v"                         # Desc: alias: vim:(Intel)设置环境变量为/usr/local/opt/macvim/bin/mvim -v
[ -f /usr/bin/vim ]; and alias lvi '/usr/bin/vim'                                                                # Desc: alias: lvi:使用系统的vim版本
[ -f /opt/homebrew/bin/vim ]; and alias vi '/opt/homebrew/bin/vim'                                               # Desc: alias: vi:(M1)设置环境变量为/opt/homebrew/bin/vim
[ -f /usr/local/bin/vim ]; and alias vi '/usr/local/bin/vim'                                                     # Desc: alias: vi:(Intel)设置环境变量为/usr/local/bin/vim
[ -f /opt/homebrew/bin/nvim ]; and alias nvi "/opt/homebrew/bin/nvim"                                            # Desc: alias: nvi:(M1)设置环境变量为/opt/homebrew/bin/nvim
[ -f /usr/local/bin/nvim ]; and alias nvi "/usr/local/bin/nvim"                                                  # Desc: alias: vi:(Intel)设置环境变量为/usr/local/bin/nvim
...
[ -f /opt/homebrew/opt/macvim/bin/mvim ]; and alias mvim '/opt/homebrew/opt/macvim/bin/mvim -v'                  # Desc: alias: mvim:(M1)设置环境变量为/opt/homebrew/opt/macvim/bin/mvim -v
[ -f /usr/local/opt/macvim/bin/mvim ]; and alias mvim '/usr/local/opt/macvim/bin/mvim -v'                        # Desc: alias: mvim:(Intel)设置环境变量为/usr/local/opt/macvim/bin/mvim -v
[ -f /opt/homebrew/opt/macvim/bin/mvim ]; and alias mvi '/opt/homebrew/opt/macvim/bin/mvim -v'                   # Desc: alias: mvi:(M1)设置环境变量为/opt/homebrew/opt/macvim/bin/mvim -v
[ -f /usr/local/opt/macvim/bin/mvim ]; and alias mvi '/usr/local/opt/macvim/bin/mvim -v'                         # Desc: alias: mvi:(Intel)设置环境变量为/usr/local/opt/macvim/bin/mvim -v
[ -f /opt/homebrew/opt/macvim/bin/vimdiff ]; and alias vimdiff "/opt/homebrew/opt/macvim/bin/vimdiff"            # Desc: alias: vimdiff:(M1)设置环境变量为/opt/homebrew/opt/macvim/bin/vimdiff
[ -f /usr/local/opt/macvim/bin/vimdiff ]; and alias vimdiff "/usr/local/opt/macvim/bin/vimdiff"                  # Desc: alias: vimdiff:(Intel)设置环境变量为/usr/local/opt/macvim/bin/vimdiff
alias ehosts 'sudo vim /etc/hosts'                                                                               # Desc: alias: ehosts:以管理员身份用vim打开/etc/hosts
[ -f /usr/local/bin/code ]; and alias code. "/usr/local/bin/code ."                                              # Desc: alias: code.:设置用vscode打开当前目录
...
alias lh "exa -l -a -h -m -n -U --git"                                                                           # Desc: alias: lh:设置为exa列出所有文件详情及git情况
[ -f /usr/local/bin/lsd ]; and alias cls '/usr/local/bin/lsd'                                                    # Desc: alias: cls:(Intel)设置环境变量为/usr/local/bin/lsd
[ -f /opt/homebrew/bin/lsd ]; and alias cls '/opt/homebrew/bin/lsd'                                              # Desc: alias: cls:(M1)设置环境变量为/opt/homebrew/bin/lsd
[ -f /usr/local/bin/ls++ ]; and alias lll "/usr/local/bin/ls++"                                                  # Desc: alias: lll:设置环境变量为/usr/local/bin/ls++
...
[ -f $MYRUNTIME/customs/others/fuzzy-fs/fuzzy-fs ]; and alias fm "$MYRUNTIME/customs/others/fuzzy-fs/fuzzy-fs"   # Desc: alias: fm:fuzzy-fs目录管理器
alias zd "zoxide"                                                                                                # Desc: alias: zd:zoxide命令的别名
alias dut "/usr/bin/du -sh"                                                                                      # Desc: alias: dut:du -sh命令的别名
...
[ -f /opt/homebrew/bin/ccat ]; and alias cat "/opt/homebrew/bin/ccat"                                            # Desc: alias: cat:(M1)设置/opt/homebrew/bin/ccat代替cat命令
[ -f /usr/local/bin/ccat ]; and alias cat "/usr/local/bin/ccat"                                                  # Desc: alias: cat:(Intel)设置/usr/local/bin/ccat代替cat命令
...
#Brew
#----------------------------------------------------------------------------------------------------------------
alias brewu 'brew update; and brew upgrade; and brew cleanup; and brew cleanup --prune-prefix; and brew doctor'  # Desc: alias: brewu:brew更新命令的别名
alias brewup 'brew update; and brew upgrade; and brew cleanup; and brew cleanup --prune-prefix; and brew doctor' # Desc: alias: brewup:brew更新命令的别名
alias bu 'brew update; and brew upgrade; and brew cleanup'                                                       # Desc: alias: bu:brew更新命令的别名

#Process
#----------------------------------------------------------------------------------------------------------------
alias memtop20 'top -l 1 -o rsize | head -n 20'                                                                  # Desc: alias: memtop20:列出进程中占用内存最高的20条
alias memtop10 'ps wwaxm -o pid,stat,vsize,rss,time,command | head -n 10'                                        # Desc: alias: memtop10:列出进程中占用内存最高的10条的详细内容
alias cputop10 'ps wwaxr -o pid,stat,%cpu,time,command | head -n 10'                                             # Desc: alias: cputop10:列出进程中占用cpu最高的前10条
...
alias gup 'git fetch; and git rebase'                                                                            # Desc: alias: gup:git fetch && git rebase命令的别名
alias gp 'git push'                                                                                              # Desc: alias: gp:git push命令的别名
alias gdv 'git diff -w "$argv" | vim -R -'                                                                       # Desc: alias: gdv:git对比并用vim打开
...
# Rm alias
#----------------------------------------------------------------------------------------------------------------
alias cleanupls "/System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister -kill -r -domain local -domain system -domain user; and killall Finder"                                                                                                  # Desc: alias: cleanupls:忘记该别名的作用了
...
# Man alias
#----------------------------------------------------------------------------------------------------------------
[ -d /usr/local/share/man/zh_CN ]; and alias cnman "man -M /usr/local/share/man/zh_CN"                           # Desc: alias: cnman:(Intel)设置中文man命令为man -M /usr/local/share/man/zh_CN
[ -d /opt/homebrew/share/man/zh ]; and alias cnman "man -M /opt/homebrew/share/man/zh"                           # Desc: alias: cnman:(m1)设置中文man命令为man -M /opt/homebrew/share/man/zh
[ -d /usr/local/share/man/zh_CN ]; and alias cman "man -M /usr/local/share/man/zh_CN"                            # Desc: alias: cman:(Intel)设置中文man命令为man -M /usr/local/share/man/zh_CN
[ -d /opt/homebrew/share/man/zh ]; and alias cman "man -M /opt/homebrew/share/man/zh"                            # Desc: alias: cman:(m1)设置中文man命令为man -M /opt/homebrew/share/man/zh
...
alias train "/opt/homebrew/bin/sl"                                                                               # Desc: alias: train:命令行小火车跑过命令的别名
[ -f $MYRUNTIME/customs/bin/game ]; and alias ssq "$MYRUNTIME/customs/bin/game lottery doubleball"               # Desc: alias: ssq: game命令双色球的别名
[ -f $MYRUNTIME/customs/bin/game ]; and alias mweb "$MYRUNTIME/customs/bin/game web open"                        # Desc: alias: mweb: game命令打开网址的别名
[ -f $MYRUNTIME/customs/bin/theme ]; and alias thl "$MYRUNTIME/customs/bin/theme --light -i"                     # Desc: alias: thl:theme命令中的亮系主题列表选择器
[ -f $MYRUNTIME/customs/bin/theme ]; and alias thd "$MYRUNTIME/customs/bin/theme --dark -i"                      # Desc: alias: thd:theme命令中的暗系主题列表选择器
[ -f /opt/homebrew/bin/code-minimap ]; and alias cmap "code-minimap"                                             # Desc: alias: cmap:code-minimap命令的别名
alias brewlogs "nvim $MYRUNTIME/customs/logs/brew_logs"                                                          # Desc: alias: brewlogs:brew包安装记录的别名
alias piplogs "nvim $MYRUNTIME/customs/logs/pip_logs"                                                            # Desc: alias: piplogs:pip包安装记录的别名
alias npmlogs "nvim $MYRUNTIME/customs/logs/npm_logs"                                                            # Desc: alias: npmlogs:npm包安装记录的别名
alias gemlogs "nvim $MYRUNTIME/customs/logs/gem_logs"                                                            # Desc: alias: gemlogs:gem包安装记录的
alias fishlogs "nvim $MYRUNTIME/customs/logs/fish_logs"                                                          # Desc: alias: fishlogs:fish包安装记录的
[ -f $MYRUNTIME/customs/bin/webmanager ]; and alias wm "$MYRUNTIME/customs/bin/webmanager"                       # Desc: alias: wm:webmanager命令的别名
[ -f $MYRUNTIME/customs/bin/webmanager ]; and alias soft "$MYRUNTIME/customs/bin/webmanager soft"                # Desc: alias: soft:webmanager命令中软件网址管理的别名
[ -f $MYRUNTIME/customs/bin/webmanager ]; and alias learn "$MYRUNTIME/customs/bin/webmanager learn"              # Desc: alias: learn:webmanager命令中学习网址管

alias a "fasd -a"                                                                                                # fasd any
alias s "fasd -si"                                                                                               # fasd show / search / select
alias d "fasd -d"                                                                                                # fasd directory
alias f "fasd -f"                                                                                                # fasd file
alias sd "fasd -sid"                                                                                             # fasd interactive directory selection
alias sf "fasd -sif"                                                                                             # fasd interactive file selection
alias z "fasd_cd -d"                                                                                             # fasd cd, same functionality as j in autojump
alias zz "fasd_cd -d -i"                                                                                         # fasd cd with interactive selection