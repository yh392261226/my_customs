...
export FZF_DEFAULT_OPTS="--height 60% --multi --cycle --inline-info --ansi --border --layout=reverse --preview '(bat --theme=gruvbox-dark --color=always --style=header,grid,numbers --line-range :600 {} || exa {}) 2> /dev/null | head -500'  --preview-window right:70%:noborder --color 'fg:252,bg:233,hl:67,fg+:252,bg+:235,hl+:81,info:144,prompt:161,spinner:135,pointer:135,marker:118,border:254'"
...
export FZF_TAB_OPTS=(-1 --cycle --inline-info --ansi --height 40% --border --layout=reverse  --expect=/ --priview '(bat --theme=gruvbox-dark --color=always --style=header,grid,numbers --line-range :600 {} || exa {}) 2> /dev/null | head -500'  --preview-window right:70%:noborder --color 'fg:#bbccdd,fg+:#ddeeff,bg:#334455,preview-bg:#223344,border:#778899')
