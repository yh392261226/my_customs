...
alias ks="ls"
alias cd..='cd ../; /usr/local/bin/lsd'                         # Go back 1 directory level (for fast typers)
alias cd.='cd ..; /usr/local/bin/lsd'
alias ..='cd ../; /usr/local/bin/lsd'                           # Go back 1 directory level
alias ...='cd ../../; /usr/local/bin/lsd'                       # Go back 2 directory levels
alias .3='cd ../../../; /usr/local/bin/lsd'                     # Go back 3 directory levels
alias .4='cd ../../../../; /usr/local/bin/lsd'                  # Go back 4 directory levels
alias .5='cd ../../../../../; /usr/local/bin/lsd'               # Go back 5 directory levels
alias .6='cd ../../../../../../; /usr/local/bin/lsd'            # Go back 6 directory levels
alias ....='cd ../../..; /usr/local/bin/lsd'
alias .....='cd ../../../..; /usr/local/bin/lsd'
alias ......='cd ../../../../..; /usr/local/bin/lsd'
