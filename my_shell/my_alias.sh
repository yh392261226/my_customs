...
alias brewlogs="nvim $MYRUNTIME/customs/brew_logs"                                                               # Desc: alias: brewlogs:brew包安装记录的别名
alias piplogs="nvim $MYRUNTIME/customs/pip_logs"                                                                 # Desc: alias: piplogs:pip包安装记录的别名
