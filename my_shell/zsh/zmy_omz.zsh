...
plugins=(mvn autojump svn svn-fast-info go history git-flow node osx cp perl python ruby rsync urltools zsh-autosuggestions zsh-syntax-highlighting web-search alias-tips yeoman codeception zsh-iterm-touchbar git-extra-commands history-substring-search zui zbrowse last-working-dir)
autoload -U compinit
#&& compinit
