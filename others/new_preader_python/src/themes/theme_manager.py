...
class ThemeManager:
    ...
    def _load_builtin_themes(self) -> None:
        ...
        # 柠檬绿主题 - 亮绿色边框，彩色按钮，透明背景
        self.themes["lemon-green"] = {
            "app.title": Style(color="#2C3E50", bold=True),
            "app.subtitle": Style(color="#34495E"),
            "app.accent": Style(color="#32CD32"),
            "app.highlight": Style(color="#FFD700"),
            "app.warning": Style(color="#FF6B6B"),
            "app.success": Style(color="#32CD32"),
            "app.info": Style(color="#3498DB"),
            "app.muted": Style(color="#7F8C8D"),
            
            "ui.border": Style(color="#ADFF2F"),  # 亮绿色边框
            "ui.background": Style(bgcolor="#000000"),  # 黑色背景代替透明
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#27AE60", bold=True),
            "ui.label": Style(color="#2C3E50"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF6B6B"),  # 彩色按钮
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#3498DB"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#32CD32"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#F39C12"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#E74C3C"),
            "ui.input": Style(color="#2C3E50", bgcolor="#333333"),
            "ui.input.focus": Style(color="#32CD32", bgcolor="#444444"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#2C3E50"),
            "content.heading": Style(color="#27AE60", bold=True),
            "content.subheading": Style(color="#34495E", bold=True),
            "content.link": Style(color="#3498DB", underline=True),
            "content.quote": Style(color="#7F8C8D", italic=True),
            "content.code": Style(color="#32CD32", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#2C3E50", bgcolor="#FFD700"),
            
            "progress.bar": Style(color="#32CD32"),
            "progress.text": Style(color="#34495E"),
            "progress.percentage": Style(color="#27AE60"),
            
            "bookshelf.title": Style(color="#27AE60", bold=True),
            "bookshelf.author": Style(color="#34495E"),
            "bookshelf.progress": Style(color="#3498DB"),
            "bookshelf.tag": Style(color="#32CD32", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#333333"),
            
            "reader.text": Style(color="#2C3E50"),
            "reader.chapter": Style(color="#27AE60", bold=True),
            "reader.page_number": Style(color="#7F8C8D"),
            "reader.bookmark": Style(color="#FFD700"),
            "reader.search_result": Style(color="#2C3E50", bgcolor="#FFD700"),
        }

        # 霓虹彩虹主题 - 多色彩主题
        self.themes["neon-rainbow"] = {
            "app.title": Style(color="#FF006E", bold=True),
            "app.subtitle": Style(color="#FB5607"),
            "app.accent": Style(color="#FFBE0B"),
            "app.highlight": Style(color="#8338EC"),
            "app.warning": Style(color="#FF006E"),
            "app.success": Style(color="#06FFB4"),
            "app.info": Style(color="#3A86FF"),
            "app.muted": Style(color="#8338EC"),
            
            "ui.border": Style(color="#FFBE0B"),
            "ui.background": Style(bgcolor="#0A0E27"),
            "ui.panel": Style(bgcolor="#2A1A3A"),
            "ui.panel.title": Style(color="#FF006E", bold=True),
            "ui.label": Style(color="#FB5607"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF006E"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#3A86FF"),
            "ui.button.success": Style(color="#0A0E27", bgcolor="#06FFB4"),
            "ui.button.warning": Style(color="#0A0E27", bgcolor="#FFBE0B"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF006E"),
            "ui.input": Style(color="#FB5607", bgcolor="#2A1A3A"),
            "ui.input.focus": Style(color="#FFBE0B", bgcolor="#4A4A1A"),
            "ui.selection": Style(bgcolor="#1A2A4A"),
            
            "content.text": Style(color="#FB5607"),
            "content.heading": Style(color="#FF006E", bold=True),
            "content.subheading": Style(color="#FFBE0B", bold=True),
            "content.link": Style(color="#3A86FF", underline=True),
            "content.quote": Style(color="#06FFB4", italic=True),
            "content.code": Style(color="#8338EC", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#0A0E27", bgcolor="#FFBE0B"),
            
            "progress.bar": Style(color="#FF006E"),
            "progress.text": Style(color="#FB5607"),
            "progress.percentage": Style(color="#FFBE0B"),
            
            "bookshelf.title": Style(color="#FF006E", bold=True),
            "bookshelf.author": Style(color="#FB5607"),
            "bookshelf.progress": Style(color="#3A86FF"),
            "bookshelf.tag": Style(color="#06FFB4", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#FB5607"),
            "reader.chapter": Style(color="#FF006E", bold=True),
            "reader.page_number": Style(color="#8338EC"),
            "reader.bookmark": Style(color="#FFBE0B"),
            "reader.search_result": Style(color="#0A0E27", bgcolor="#FFBE0B"),
        }

        # 热带风情主题
        self.themes["tropical-vibes"] = {
            "app.title": Style(color="#FF6B35", bold=True),
            "app.subtitle": Style(color="#F7931E"),
            "app.accent": Style(color="#FDC830"),
            "app.highlight": Style(color="#F37335"),
            "app.warning": Style(color="#FF6B35"),
            "app.success": Style(color="#00C896"),
            "app.info": Style(color="#00B4D8"),
            "app.muted": Style(color="#F7931E"),
            
            "ui.border": Style(color="#FDC830"),
            "ui.background": Style(bgcolor="#1A1A2E"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF6B35", bold=True),
            "ui.label": Style(color="#F7931E"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF6B35"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#00B4D8"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#00C896"),
            "ui.button.warning": Style(color="#1A1A2E", bgcolor="#FDC830"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF6B35"),
            "ui.input": Style(color="#F7931E", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FDC830", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#F7931E"),
            "content.heading": Style(color="#FF6B35", bold=True),
            "content.subheading": Style(color="#FDC830", bold=True),
            "content.link": Style(color="#00B4D8", underline=True),
            "content.quote": Style(color="#00C896", italic=True),
            "content.code": Style(color="#F37335", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#1A1A2E", bgcolor="#FDC830"),
            
            "progress.bar": Style(color="#FF6B35"),
            "progress.text": Style(color="#F7931E"),
            "progress.percentage": Style(color="#FDC830"),
            
            "bookshelf.title": Style(color="#FF6B35", bold=True),
            "bookshelf.author": Style(color="#F7931E"),
            "bookshelf.progress": Style(color="#00B4D8"),
            "bookshelf.tag": Style(color="#00C896", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#F7931E"),
            "reader.chapter": Style(color="#FF6B35", bold=True),
            "reader.page_number": Style(color="#F37335"),
            "reader.bookmark": Style(color="#FDC830"),
            "reader.search_result": Style(color="#1A1A2E", bgcolor="#FDC830"),
        }

        # 糖果爆炸主题
        self.themes["candy-explosion"] = {
            "app.title": Style(color="#FF1493", bold=True),
            "app.subtitle": Style(color="#00CED1"),
            "app.accent": Style(color="#FFD700"),
            "app.highlight": Style(color="#FF69B4"),
            "app.warning": Style(color="#FF1493"),
            "app.success": Style(color="#32CD32"),
            "app.info": Style(color="#00CED1"),
            "app.muted": Style(color="#9370DB"),
            
            "ui.border": Style(color="#FFD700"),
            "ui.background": Style(bgcolor="#2C003E"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF1493", bold=True),
            "ui.label": Style(color="#00CED1"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF1493"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#00CED1"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#32CD32"),
            "ui.button.warning": Style(color="#2C003E", bgcolor="#FFD700"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF1493"),
            "ui.input": Style(color="#00CED1", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FFD700", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#00CED1"),
            "content.heading": Style(color="#FF1493", bold=True),
            "content.subheading": Style(color="#FFD700", bold=True),
            "content.link": Style(color="#FF69B4", underline=True),
            "content.quote": Style(color="#32CD32", italic=True),
            "content.code": Style(color="#9370DB", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#2C003E", bgcolor="#FFD700"),
            
            "progress.bar": Style(color="#FF1493"),
            "progress.text": Style(color="#00CED1"),
            "progress.percentage": Style(color="#FFD700"),
            
            "bookshelf.title": Style(color="#FF1493", bold=True),
            "bookshelf.author": Style(color="#00CED1"),
            "bookshelf.progress": Style(color="#FF69B4"),
            "bookshelf.tag": Style(color="#32CD32", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#00CED1"),
            "reader.chapter": Style(color="#FF1493", bold=True),
            "reader.page_number": Style(color="#9370DB"),
            "reader.bookmark": Style(color="#FFD700"),
            "reader.search_result": Style(color="#2C003E", bgcolor="#FFD700"),
        }

        # 电子蓝主题
        self.themes["electric-blue"] = {
            "app.title": Style(color="#00D9FF", bold=True),
            "app.subtitle": Style(color="#0099CC"),
            "app.accent": Style(color="#00FFFF"),
            "app.highlight": Style(color="#FF00FF"),
            "app.warning": Style(color="#FF6B6B"),
            "app.success": Style(color="#00FF88"),
            "app.info": Style(color="#00D9FF"),
            "app.muted": Style(color="#006699"),
            
            "ui.border": Style(color="#00FFFF"),
            "ui.background": Style(bgcolor="#000814"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#00D9FF", bold=True),
            "ui.label": Style(color="#0099CC"),
            "ui.button": Style(color="#000814", bgcolor="#00D9FF"),
            "ui.button.primary": Style(color="#000814", bgcolor="#00FFFF"),
            "ui.button.success": Style(color="#000814", bgcolor="#00FF88"),
            "ui.button.warning": Style(color="#000814", bgcolor="#FF00FF"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF6B6B"),
            "ui.input": Style(color="#00D9FF", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#00FFFF", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#00D9FF"),
            "content.heading": Style(color="#00FFFF", bold=True),
            "content.subheading": Style(color="#0099CC", bold=True),
            "content.link": Style(color="#FF00FF", underline=True),
            "content.quote": Style(color="#00FF88", italic=True),
            "content.code": Style(color="#00FFFF", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#000814", bgcolor="#FF00FF"),
            
            "progress.bar": Style(color="#00D9FF"),
            "progress.text": Style(color="#0099CC"),
            "progress.percentage": Style(color="#00FFFF"),
            
            "bookshelf.title": Style(color="#00D9FF", bold=True),
            "bookshelf.author": Style(color="#0099CC"),
            "bookshelf.progress": Style(color="#FF00FF"),
            "bookshelf.tag": Style(color="#00FF88", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#00D9FF"),
            "reader.chapter": Style(color="#00FFFF", bold=True),
            "reader.page_number": Style(color="#006699"),
            "reader.bookmark": Style(color="#FF00FF"),
            "reader.search_result": Style(color="#000814", bgcolor="#FF00FF"),
        }

        # 玫红冲击主题
        self.themes["magenta-blast"] = {
            "app.title": Style(color="#FF00FF", bold=True),
            "app.subtitle": Style(color="#FF1493"),
            "app.accent": Style(color="#FF69B4"),
            "app.highlight": Style(color="#FFD700"),
            "app.warning": Style(color="#FF4500"),
            "app.success": Style(color="#00FA9A"),
            "app.info": Style(color="#00BFFF"),
            "app.muted": Style(color="#C71585"),
            
            "ui.border": Style(color="#FF69B4"),
            "ui.background": Style(bgcolor="#1A0033"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF00FF", bold=True),
            "ui.label": Style(color="#FF1493"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF00FF"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#FF69B4"),
            "ui.button.success": Style(color="#1A0033", bgcolor="#00FA9A"),
            "ui.button.warning": Style(color="#1A0033", bgcolor="#FFD700"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF4500"),
            "ui.input": Style(color="#FF1493", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FF69B4", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#FF1493"),
            "content.heading": Style(color="#FF00FF", bold=True),
            "content.subheading": Style(color="#FF69B4", bold=True),
            "content.link": Style(color="#00BFFF", underline=True),
            "content.quote": Style(color="#00FA9A", italic=True),
            "content.code": Style(color="#C71585", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#1A0033", bgcolor="#FFD700"),
            
            "progress.bar": Style(color="#FF00FF"),
            "progress.text": Style(color="#FF1493"),
            "progress.percentage": Style(color="#FF69B4"),
            
            "bookshelf.title": Style(color="#FF00FF", bold=True),
            "bookshelf.author": Style(color="#FF1493"),
            "bookshelf.progress": Style(color="#00BFFF"),
            "bookshelf.tag": Style(color="#00FA9A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#FF1493"),
            "reader.chapter": Style(color="#FF00FF", bold=True),
            "reader.page_number": Style(color="#C71585"),
            "reader.bookmark": Style(color="#FFD700"),
            "reader.search_result": Style(color="#1A0033", bgcolor="#FFD700"),
        }

        # 柑橘爆发主题
        self.themes["citrus-burst"] = {
            "app.title": Style(color="#FF8C00", bold=True),
            "app.subtitle": Style(color="#FFA500"),
            "app.accent": Style(color="#FFD700"),
            "app.highlight": Style(color="#FF6347"),
            "app.warning": Style(color="#DC143C"),
            "app.success": Style(color="#32CD32"),
            "app.info": Style(color="#4169E1"),
            "app.muted": Style(color="#FF8C00"),
            
            "ui.border": Style(color="#FFD700"),
            "ui.background": Style(bgcolor="#2F1B14"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF8C00", bold=True),
            "ui.label": Style(color="#FFA500"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF8C00"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#FFD700"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#32CD32"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FF6347"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#DC143C"),
            "ui.input": Style(color="#FFA500", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FFD700", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#FFA500"),
            "content.heading": Style(color="#FF8C00", bold=True),
            "content.subheading": Style(color="#FFD700", bold=True),
            "content.link": Style(color="#4169E1", underline=True),
            "content.quote": Style(color="#32CD32", italic=True),
            "content.code": Style(color="#FF6347", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#2F1B14", bgcolor="#FFD700"),
            
            "progress.bar": Style(color="#FF8C00"),
            "progress.text": Style(color="#FFA500"),
            "progress.percentage": Style(color="#FFD700"),
            
            "bookshelf.title": Style(color="#FF8C00", bold=True),
            "bookshelf.author": Style(color="#FFA500"),
            "bookshelf.progress": Style(color="#4169E1"),
            "bookshelf.tag": Style(color="#32CD32", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#FFA500"),
            "reader.chapter": Style(color="#FF8C00", bold=True),
            "reader.page_number": Style(color="#FF6347"),
            "reader.bookmark": Style(color="#FFD700"),
            "reader.search_result": Style(color="#2F1B14", bgcolor="#FFD700"),
        }

        # 银河主题
        self.themes["galaxy-theme"] = {
            "app.title": Style(color="#E0B0FF", bold=True),
            "app.subtitle": Style(color="#DDA0DD"),
            "app.accent": Style(color="#9370DB"),
            "app.highlight": Style(color="#FFD700"),
            "app.warning": Style(color="#FF69B4"),
            "app.success": Style(color="#00FA9A"),
            "app.info": Style(color="#87CEEB"),
            "app.muted": Style(color="#9370DB"),
            
            "ui.border": Style(color="#9370DB"),
            "ui.background": Style(bgcolor="#0F0F23"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#E0B0FF", bold=True),
            "ui.label": Style(color="#DDA0DD"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#9370DB"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#87CEEB"),
            "ui.button.success": Style(color="#0F0F23", bgcolor="#00FA9A"),
            "ui.button.warning": Style(color="#0F0F23", bgcolor="#FFD700"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF69B4"),
            "ui.input": Style(color="#DDA0DD", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#E0B0FF", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#DDA0DD"),
            "content.heading": Style(color="#E0B0FF", bold=True),
            "content.subheading": Style(color="#9370DB", bold=True),
            "content.link": Style(color="#87CEEB", underline=True),
            "content.quote": Style(color="#00FA9A", italic=True),
            "content.code": Style(color="#FF69B4", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#0F0F23", bgcolor="#FFD700"),
            
            "progress.bar": Style(color="#9370DB"),
            "progress.text": Style(color="#DDA0DD"),
            "progress.percentage": Style(color="#E0B0FF"),
            
            "bookshelf.title": Style(color="#E0B0FF", bold=True),
            "bookshelf.author": Style(color="#DDA0DD"),
            "bookshelf.progress": Style(color="#87CEEB"),
            "bookshelf.tag": Style(color="#00FA9A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#DDA0DD"),
            "reader.chapter": Style(color="#E0B0FF", bold=True),
            "reader.page_number": Style(color="#9370DB"),
            "reader.bookmark": Style(color="#FFD700"),
            "reader.search_result": Style(color="#0F0F23", bgcolor="#FFD700"),
        }

        # 节日主题
        self.themes["fiesta-theme"] = {
            "app.title": Style(color="#FF1744", bold=True),
            "app.subtitle": Style(color="#F50057"),
            "app.accent": Style(color="#D500F9"),
            "app.highlight": Style(color="#651FFF"),
            "app.warning": Style(color="#FF1744"),
            "app.success": Style(color="#00E676"),
            "app.info": Style(color="#00E5FF"),
            "app.muted": Style(color="#F50057"),
            
            "ui.border": Style(color="#D500F9"),
            "ui.background": Style(bgcolor="#1A0033"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF1744", bold=True),
            "ui.label": Style(color="#F50057"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF1744"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#D500F9"),
            "ui.button.success": Style(color="#1A0033", bgcolor="#00E676"),
            "ui.button.warning": Style(color="#1A0033", bgcolor="#651FFF"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF1744"),
            "ui.input": Style(color="#F50057", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#D500F9", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#F50057"),
            "content.heading": Style(color="#FF1744", bold=True),
            "content.subheading": Style(color="#D500F9", bold=True),
            "content.link": Style(color="#00E5FF", underline=True),
            "content.quote": Style(color="#00E676", italic=True),
            "content.code": Style(color="#651FFF", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#1A0033", bgcolor="#651FFF"),
            
            "progress.bar": Style(color="#FF1744"),
            "progress.text": Style(color="#F50057"),
            "progress.percentage": Style(color="#D500F9"),
            
            "bookshelf.title": Style(color="#FF1744", bold=True),
            "bookshelf.author": Style(color="#F50057"),
            "bookshelf.progress": Style(color="#00E5FF"),
            "bookshelf.tag": Style(color="#00E676", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#F50057"),
            "reader.chapter": Style(color="#FF1744", bold=True),
            "reader.page_number": Style(color="#651FFF"),
            "reader.bookmark": Style(color="#D500F9"),
            "reader.search_result": Style(color="#1A0033", bgcolor="#D500F9"),
        }

        # 薄荷清新主题
        self.themes["mint-fresh"] = {
            "app.title": Style(color="#00BCD4", bold=True),
            "app.subtitle": Style(color="#26C6DA"),
            "app.accent": Style(color="#4DD0E1"),
            "app.highlight": Style(color="#80DEEA"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#00BCD4"),
            "app.muted": Style(color="#26C6DA"),
            
            "ui.border": Style(color="#4DD0E1"),
            "ui.background": Style(bgcolor="#E0F7FA"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#00BCD4", bold=True),
            "ui.label": Style(color="#26C6DA"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#00BCD4"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#4DD0E1"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#F44336"),
            "ui.input": Style(color="#26C6DA", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#4DD0E1", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#26C6DA"),
            "content.heading": Style(color="#00BCD4", bold=True),
            "content.subheading": Style(color="#4DD0E1", bold=True),
            "content.link": Style(color="#0288D1", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#0097A7", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#E0F7FA", bgcolor="#80DEEA"),
            
            "progress.bar": Style(color="#00BCD4"),
            "progress.text": Style(color="#26C6DA"),
            "progress.percentage": Style(color="#4DD0E1"),
            
            "bookshelf.title": Style(color="#00BCD4", bold=True),
            "bookshelf.author": Style(color="#26C6DA"),
            "bookshelf.progress": Style(color="#0288D1"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#26C6DA"),
            "reader.chapter": Style(color="#00BCD4", bold=True),
            "reader.page_number": Style(color="#0097A7"),
            "reader.bookmark": Style(color="#4DD0E1"),
            "reader.search_result": Style(color="#E0F7FA", bgcolor="#80DEEA"),
        }

        # 翡翠绿主题
        self.themes["emerald-green"] = {
            "app.title": Style(color="#2E7D32", bold=True),
            "app.subtitle": Style(color="#388E3C"),
            "app.accent": Style(color="#43A047"),
            "app.highlight": Style(color="#4CAF50"),
            "app.warning": Style(color="#FFA726"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#26C6DA"),
            "app.muted": Style(color="#388E3C"),
            
            "ui.border": Style(color="#4CAF50"),
            "ui.background": Style(bgcolor="#E8F5E8"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#2E7D32", bold=True),
            "ui.label": Style(color="#388E3C"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#2E7D32"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#43A047"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFA726"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#EF5350"),
            "ui.input": Style(color="#388E3C", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#43A047", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#388E3C"),
            "content.heading": Style(color="#2E7D32", bold=True),
            "content.subheading": Style(color="#43A047", bold=True),
            "content.link": Style(color="#26C6DA", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#1B5E20", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#E8F5E8", bgcolor="#4CAF50"),
            
            "progress.bar": Style(color="#2E7D32"),
            "progress.text": Style(color="#388E3C"),
            "progress.percentage": Style(color="#43A047"),
            
            "bookshelf.title": Style(color="#2E7D32", bold=True),
            "bookshelf.author": Style(color="#388E3C"),
            "bookshelf.progress": Style(color="#26C6DA"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#388E3C"),
            "reader.chapter": Style(color="#2E7D32", bold=True),
            "reader.page_number": Style(color="#1B5E20"),
            "reader.bookmark": Style(color="#4CAF50"),
            "reader.search_result": Style(color="#E8F5E8", bgcolor="#4CAF50"),
        }

        # 紫罗兰主题
        self.themes["violet-dream"] = {
            "app.title": Style(color="#7B1FA2", bold=True),
            "app.subtitle": Style(color="#8E24AA"),
            "app.accent": Style(color="#9C27B0"),
            "app.highlight": Style(color="#AB47BC"),
            "app.warning": Style(color="#FFA726"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#42A5F5"),
            "app.muted": Style(color="#8E24AA"),
            
            "ui.border": Style(color="#9C27B0"),
            "ui.background": Style(bgcolor="#F3E5F5"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#7B1FA2", bold=True),
            "ui.label": Style(color="#8E24AA"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#7B1FA2"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#9C27B0"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFA726"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#EF5350"),
            "ui.input": Style(color="#8E24AA", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#9C27B0", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#8E24AA"),
            "content.heading": Style(color="#7B1FA2", bold=True),
            "content.subheading": Style(color="#9C27B0", bold=True),
            "content.link": Style(color="#42A5F5", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#6A1B9A", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#F3E5F5", bgcolor="#AB47BC"),
            
            "progress.bar": Style(color="#7B1FA2"),
            "progress.text": Style(color="#8E24AA"),
            "progress.percentage": Style(color="#9C27B0"),
            
            "bookshelf.title": Style(color="#7B1FA2", bold=True),
            "bookshelf.author": Style(color="#8E24AA"),
            "bookshelf.progress": Style(color="#42A5F5"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#8E24AA"),
            "reader.chapter": Style(color="#7B1FA2", bold=True),
            "reader.page_number": Style(color="#6A1B9A"),
            "reader.bookmark": Style(color="#AB47BC"),
            "reader.search_result": Style(color="#F3E5F5", bgcolor="#AB47BC"),
        }

        # 琥珀主题
        self.themes["amber-glow"] = {
            "app.title": Style(color="#FF6F00", bold=True),
            "app.subtitle": Style(color="#FF8F00"),
            "app.accent": Style(color="#FFA000"),
            "app.highlight": Style(color="#FFB300"),
            "app.warning": Style(color="#FF5722"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#42A5F5"),
            "app.muted": Style(color="#FF8F00"),
            
            "ui.border": Style(color="#FFA000"),
            "ui.background": Style(bgcolor="#FFF8E1"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF6F00", bold=True),
            "ui.label": Style(color="#FF8F00"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF6F00"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#FFA000"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFB300"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF5722"),
            "ui.input": Style(color="#FF8F00", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FFA000", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#FF8F00"),
            "content.heading": Style(color="#FF6F00", bold=True),
            "content.subheading": Style(color="#FFA000", bold=True),
            "content.link": Style(color="#42A5F5", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#E65100", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#FFF8E1", bgcolor="#FFB300"),
            
            "progress.bar": Style(color="#FF6F00"),
            "progress.text": Style(color="#FF8F00"),
            "progress.percentage": Style(color="#FFA000"),
            
            "bookshelf.title": Style(color="#FF6F00", bold=True),
            "bookshelf.author": Style(color="#FF8F00"),
            "bookshelf.progress": Style(color="#42A5F5"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#FF8F00"),
            "reader.chapter": Style(color="#FF6F00", bold=True),
            "reader.page_number": Style(color="#E65100"),
            "reader.bookmark": Style(color="#FFB300"),
            "reader.search_result": Style(color="#FFF8E1", bgcolor="#FFB300"),
        }

        # 珊瑚主题
        self.themes["coral-reef"] = {
            "app.title": Style(color="#FF5722", bold=True),
            "app.subtitle": Style(color="#FF7043"),
            "app.accent": Style(color="#FF8A65"),
            "app.highlight": Style(color="#FFAB91"),
            "app.warning": Style(color="#F44336"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#42A5F5"),
            "app.muted": Style(color="#FF7043"),
            
            "ui.border": Style(color="#FF8A65"),
            "ui.background": Style(bgcolor="#FBE9E7"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF5722", bold=True),
            "ui.label": Style(color="#FF7043"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF5722"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#FF8A65"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFAB91"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#F44336"),
            "ui.input": Style(color="#FF7043", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#FF8A65", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#FF7043"),
            "content.heading": Style(color="#FF5722", bold=True),
            "content.subheading": Style(color="#FF8A65", bold=True),
            "content.link": Style(color="#42A5F5", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#D84315", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#FBE9E7", bgcolor="#FFAB91"),
            
            "progress.bar": Style(color="#FF5722"),
            "progress.text": Style(color="#FF7043"),
            "progress.percentage": Style(color="#FF8A65"),
            
            "bookshelf.title": Style(color="#FF5722", bold=True),
            "bookshelf.author": Style(color="#FF7043"),
            "bookshelf.progress": Style(color="#42A5F5"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#FF7043"),
            "reader.chapter": Style(color="#FF5722", bold=True),
            "reader.page_number": Style(color="#D84315"),
            "reader.bookmark": Style(color="#FFAB91"),
            "reader.search_result": Style(color="#FBE9E7", bgcolor="#FFAB91"),
        }

        # 天空蓝主题
        self.themes["sky-blue"] = {
            "app.title": Style(color="#1976D2", bold=True),
            "app.subtitle": Style(color="#1E88E5"),
            "app.accent": Style(color="#2196F3"),
            "app.highlight": Style(color="#42A5F5"),
            "app.warning": Style(color="#FFA726"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#29B6F6"),
            "app.muted": Style(color="#1E88E5"),
            
            "ui.border": Style(color="#2196F3"),
            "ui.background": Style(bgcolor="#E3F2FD"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#1976D2", bold=True),
            "ui.label": Style(color="#1E88E5"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#1976D2"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#2196F3"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFA726"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#EF5350"),
            "ui.input": Style(color="#1E88E5", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#2196F3", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#1E88E5"),
            "content.heading": Style(color="#1976D2", bold=True),
            "content.subheading": Style(color="#2196F3", bold=True),
            "content.link": Style(color="#29B6F6", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#0D47A1", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#E3F2FD", bgcolor="#42A5F5"),
            
            "progress.bar": Style(color="#1976D2"),
            "progress.text": Style(color="#1E88E5"),
            "progress.percentage": Style(color="#2196F3"),
            
            "bookshelf.title": Style(color="#1976D2", bold=True),
            "bookshelf.author": Style(color="#1E88E5"),
            "bookshelf.progress": Style(color="#29B6F6"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#1E88E5"),
            "reader.chapter": Style(color="#1976D2", bold=True),
            "reader.page_number": Style(color="#0D47A1"),
            "reader.bookmark": Style(color="#42A5F5"),
            "reader.search_result": Style(color="#E3F2FD", bgcolor="#42A5F5"),
        }

        # 薄荷绿主题
        self.themes["mint-green"] = {
            "app.title": Style(color="#00897B", bold=True),
            "app.subtitle": Style(color="#009688"),
            "app.accent": Style(color="#26A69A"),
            "app.highlight": Style(color="#4DB6AC"),
            "app.warning": Style(color="#FFA726"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#26C6DA"),
            "app.muted": Style(color="#009688"),
            
            "ui.border": Style(color="#26A69A"),
            "ui.background": Style(bgcolor="#E0F2F1"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#00897B", bold=True),
            "ui.label": Style(color="#009688"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#00897B"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#26A69A"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFA726"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#EF5350"),
            "ui.input": Style(color="#009688", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#26A69A", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#009688"),
            "content.heading": Style(color="#00897B", bold=True),
            "content.subheading": Style(color="#26A69A", bold=True),
            "content.link": Style(color="#26C6DA", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#004D40", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#E0F2F1", bgcolor="#4DB6AC"),
            
            "progress.bar": Style(color="#00897B"),
            "progress.text": Style(color="#009688"),
            "progress.percentage": Style(color="#26A69A"),
            
            "bookshelf.title": Style(color="#00897B", bold=True),
            "bookshelf.author": Style(color="#009688"),
            "bookshelf.progress": Style(color="#26C6DA"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#009688"),
            "reader.chapter": Style(color="#00897B", bold=True),
            "reader.page_number": Style(color="#004D40"),
            "reader.bookmark": Style(color="#4DB6AC"),
            "reader.search_result": Style(color="#E0F2F1", bgcolor="#4DB6AC"),
        }

        # 薰衣草主题
        self.themes["lavender-field"] = {
            "app.title": Style(color="#7E57C2", bold=True),
            "app.subtitle": Style(color="#9575CD"),
            "app.accent": Style(color="#B39DDB"),
            "app.highlight": Style(color="#D1C4E9"),
            "app.warning": Style(color="#FFA726"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#42A5F5"),
            "app.muted": Style(color="#9575CD"),
            
            "ui.border": Style(color="#B39DDB"),
            "ui.background": Style(bgcolor="#EDE7F6"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#7E57C2", bold=True),
            "ui.label": Style(color="#9575CD"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#7E57C2"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#B39DDB"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FFA726"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#EF5350"),
            "ui.input": Style(color="#9575CD", bgcolor="#1A1A1A"),
            "ui.input.focus": Style(color="#B39DDB", bgcolor="#1A1A1A"),
            "ui.selection": Style(bgcolor="#1A1A1A"),
            
            "content.text": Style(color="#9575CD"),
            "content.heading": Style(color="#7E57C2", bold=True),
            "content.subheading": Style(color="#B39DDB", bold=True),
            "content.link": Style(color="#42A5F5", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#512DA8", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#EDE7F6", bgcolor="#D1C4E9"),
            
            "progress.bar": Style(color="#7E57C2"),
            "progress.text": Style(color="#9575CD"),
            "progress.percentage": Style(color="#B39DDB"),
            
            "bookshelf.title": Style(color="#7E57C2", bold=True),
            "bookshelf.author": Style(color="#9575CD"),
            "bookshelf.progress": Style(color="#42A5F5"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#1A1A1A"),
            "bookshelf.selected": Style(bgcolor="#1A1A1A"),
            
            "reader.text": Style(color="#9575CD"),
            "reader.chapter": Style(color="#7E57C2", bold=True),
            "reader.page_number": Style(color="#512DA8"),
            "reader.bookmark": Style(color="#D1C4E9"),
            "reader.search_result": Style(color="#EDE7F6", bgcolor="#D1C4E9"),
        }

        # 日落主题
        self.themes["sunset-glow"] = {
            "app.title": Style(color="#FF5722", bold=True),
            "app.subtitle": Style(color="#FF7043"),
            "app.accent": Style(color="#FF8A65"),
            "app.highlight": Style(color="#FFAB91"),
            ...
            "ui.border": Style(color="#FF8A65"),
            "ui.background": Style(bgcolor="#FFF3E0"),
            "ui.panel": Style(bgcolor="#1A1A1A"),
            "ui.panel.title": Style(color="#FF5722", bold=True),
            "ui.label": Style(color="#FF7043"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#FF5722"),
            ...
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#D84315", bgcolor="#1A1A1A"),
            "content.highlight": Style(color="#FFF3E0", bgcolor="#FFAB91"),
            ...
            "reader.page_number": Style(color="#D84315"),
            "reader.bookmark": Style(color="#FFAB91"),
            "reader.search_result": Style(color="#FFF3E0", bgcolor="#FFAB91"),
        }

        # 樱形切割主题 - 几何风格
        self.themes["diamond-cut"] = {
            "app.title": Style(color="#00ACC1", bold=True),
            "app.subtitle": Style(color="#0097A7"),
            "app.accent": Style(color="#00BCD4"),
            "app.highlight": Style(color="#00E5FF"),
            "app.warning": Style(color="#FF6E40"),
            "app.success": Style(color="#00E676"),
            "app.info": Style(color="#2979FF"),
            "app.muted": Style(color="#00838F"),
            
            "ui.border": Style(color="#00BCD4"),
            "ui.background": Style(bgcolor="#004D40"),
            "ui.panel": Style(bgcolor="#00695C"),
            "ui.panel.title": Style(color="#00ACC1", bold=True),
            "ui.label": Style(color="#0097A7"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#00ACC1"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#00BCD4"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#00E676"),
            "ui.button.warning": Style(color="#FFFFFF", bgcolor="#FF6E40"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF5252"),
            "ui.input": Style(color="#0097A7", bgcolor="#00695C"),
            "ui.input.focus": Style(color="#00BCD4", bgcolor="#00796B"),
            "ui.selection": Style(bgcolor="#00897B"),
            
            "content.text": Style(color="#0097A7"),
            "content.heading": Style(color="#00ACC1", bold=True),
            "content.subheading": Style(color="#00BCD4", bold=True),
            "content.link": Style(color="#2979FF", underline=True),
            "content.quote": Style(color="#00E676", italic=True),
            "content.code": Style(color="#00E5FF", bgcolor="#004D40"),
            "content.highlight": Style(color="#004D40", bgcolor="#00E5FF"),
            
            "progress.bar": Style(color="#00ACC1"),
            "progress.text": Style(color="#0097A7"),
            "progress.percentage": Style(color="#00BCD4"),
            
            "bookshelf.title": Style(color="#00ACC1", bold=True),
            "bookshelf.author": Style(color="#0097A7"),
            "bookshelf.progress": Style(color="#2979FF"),
            "bookshelf.tag": Style(color="#00E676", bgcolor="#00695C"),
            "bookshelf.selected": Style(bgcolor="#00796B"),
            
            "reader.text": Style(color="#0097A7"),
            "reader.chapter": Style(color="#00ACC1", bold=True),
            "reader.page_number": Style(color="#00838F"),
            "reader.bookmark": Style(color="#00E5FF"),
            "reader.search_result": Style(color="#004D40", bgcolor="#00E5FF"),
        }

        # 深海珍珠主题
        self.themes["deep-sea-pearl"] = {
            "app.title": Style(color="#E0F2F1", bold=True),
            "app.subtitle": Style(color="#B2DFDB"),
            "app.accent": Style(color="#80CBC4"),
            "app.highlight": Style(color="#4DB6AC"),
            "app.warning": Style(color="#FFB74D"),
            "app.success": Style(color="#81C784"),
            "app.info": Style(color="#64B5F6"),
            "app.muted": Style(color="#607D8B"),
            
            "ui.border": Style(color="#80CBC4"),
            "ui.background": Style(bgcolor="#004D40"),
            "ui.panel": Style(bgcolor="#00695C"),
            "ui.panel.title": Style(color="#E0F2F1", bold=True),
            "ui.label": Style(color="#B2DFDB"),
            "ui.button": Style(color="#004D40", bgcolor="#E0F2F1"),
            "ui.button.primary": Style(color="#004D40", bgcolor="#80CBC4"),
            "ui.button.success": Style(color="#004D40", bgcolor="#81C784"),
            "ui.button.warning": Style(color="#004D40", bgcolor="#FFB74D"),
            "ui.button.danger": Style(color="#E0F2F1", bgcolor="#E57373"),
            "ui.input": Style(color="#B2DFDB", bgcolor="#00695C"),
            "ui.input.focus": Style(color="#E0F2F1", bgcolor="#00796B"),
            "ui.selection": Style(bgcolor="#00897B"),
            
            "content.text": Style(color="#B2DFDB"),
            "content.heading": Style(color="#E0F2F1", bold=True),
            "content.subheading": Style(color="#80CBC4", bold=True),
            "content.link": Style(color="#64B5F6", underline=True),
            "content.quote": Style(color="#81C784", italic=True),
            "content.code": Style(color="#4DB6AC", bgcolor="#004D40"),
            "content.highlight": Style(color="#004D40", bgcolor="#4DB6AC"),
            
            "progress.bar": Style(color="#E0F2F1"),
            "progress.text": Style(color="#B2DFDB"),
            "progress.percentage": Style(color="#80CBC4"),
            
            "bookshelf.title": Style(color="#E0F2F1", bold=True),
            "bookshelf.author": Style(color="#B2DFDB"),
            "bookshelf.progress": Style(color="#64B5F6"),
            "bookshelf.tag": Style(color="#81C784", bgcolor="#00695C"),
            "bookshelf.selected": Style(bgcolor="#00796B"),
            
            "reader.text": Style(color="#B2DFDB"),
            "reader.chapter": Style(color="#E0F2F1", bold=True),
            "reader.page_number": Style(color="#607D8B"),
            "reader.bookmark": Style(color="#4DB6AC"),
            "reader.search_result": Style(color="#004D40", bgcolor="#4DB6AC"),
        }

        # 赛博朋克霓虹主题
        self.themes["cyberpunk-neon"] = {
            "app.title": Style(color="#FF00FF", bold=True),
            "app.subtitle": Style(color="#00FFFF"),
            "app.accent": Style(color="#FF1493"),
            "app.highlight": Style(color="#00FF00"),
            "app.warning": Style(color="#FF6600"),
            "app.success": Style(color="#00FF00"),
            "app.info": Style(color="#00BFFF"),
            "app.muted": Style(color="#9932CC"),
            
            "ui.border": Style(color="#FF1493"),
            "ui.background": Style(bgcolor="#0A0A0A"),
            "ui.panel": Style(bgcolor="#1A1A2E"),
            "ui.panel.title": Style(color="#FF00FF", bold=True),
            "ui.label": Style(color="#00FFFF"),
            "ui.button": Style(color="#0A0A0A", bgcolor="#FF00FF"),
            "ui.button.primary": Style(color="#0A0A0A", bgcolor="#00FFFF"),
            "ui.button.success": Style(color="#0A0A0A", bgcolor="#00FF00"),
            "ui.button.warning": Style(color="#0A0A0A", bgcolor="#FF6600"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF1493"),
            "ui.input": Style(color="#00FFFF", bgcolor="#1A1A2E"),
            "ui.input.focus": Style(color="#FF00FF", bgcolor="#2D2D44"),
            "ui.selection": Style(bgcolor="#1A1A2E"),
            
            "content.text": Style(color="#00FFFF"),
            "content.heading": Style(color="#FF00FF", bold=True),
            "content.subheading": Style(color="#FF1493", bold=True),
            "content.link": Style(color="#00BFFF", underline=True),
            "content.quote": Style(color="#00FF00", italic=True),
            "content.code": Style(color="#9932CC", bgcolor="#0A0A0A"),
            "content.highlight": Style(color="#0A0A0A", bgcolor="#00FF00"),
            
            "progress.bar": Style(color="#FF00FF"),
            "progress.text": Style(color="#00FFFF"),
            "progress.percentage": Style(color="#FF1493"),
            
            "bookshelf.title": Style(color="#FF00FF", bold=True),
            "bookshelf.author": Style(color="#00FFFF"),
            "bookshelf.progress": Style(color="#00BFFF"),
            "bookshelf.tag": Style(color="#00FF00", bgcolor="#1A1A2E"),
            "bookshelf.selected": Style(bgcolor="#2D2D44"),
            
            "reader.text": Style(color="#00FFFF"),
            "reader.chapter": Style(color="#FF00FF", bold=True),
            "reader.page_number": Style(color="#9932CC"),
            "reader.bookmark": Style(color="#00FF00"),
            "reader.search_result": Style(color="#0A0A0A", bgcolor="#00FF00"),
        }

        # 北欧森林主题
        self.themes["nordic-forest"] = {
            "app.title": Style(color="#D8DEE9", bold=True),
            "app.subtitle": Style(color="#E5E9F0"),
            "app.accent": Style(color="#8FBCBB"),
            "app.highlight": Style(color="#88C0D0"),
            "app.warning": Style(color="#D08770"),
            "app.success": Style(color="#A3BE8C"),
            "app.info": Style(color="#5E81AC"),
            "app.muted": Style(color="#4C566A"),
            
            "ui.border": Style(color="#8FBCBB"),
            "ui.background": Style(bgcolor="#2E3440"),
            "ui.panel": Style(bgcolor="#3B4252"),
            "ui.panel.title": Style(color="#D8DEE9", bold=True),
            "ui.label": Style(color="#E5E9F0"),
            "ui.button": Style(color="#2E3440", bgcolor="#8FBCBB"),
            "ui.button.primary": Style(color="#2E3440", bgcolor="#88C0D0"),
            "ui.button.success": Style(color="#2E3440", bgcolor="#A3BE8C"),
            "ui.button.warning": Style(color="#2E3440", bgcolor="#D08770"),
            "ui.button.danger": Style(color="#E5E9F0", bgcolor="#BF616A"),
            "ui.input": Style(color="#E5E9F0", bgcolor="#3B4252"),
            "ui.input.focus": Style(color="#8FBCBB", bgcolor="#434C5E"),
            "ui.selection": Style(bgcolor="#434C5E"),
            
            "content.text": Style(color="#E5E9F0"),
            "content.heading": Style(color="#D8DEE9", bold=True),
            "content.subheading": Style(color="#8FBCBB", bold=True),
            "content.link": Style(color="#5E81AC", underline=True),
            "content.quote": Style(color="#A3BE8C", italic=True),
            "content.code": Style(color="#88C0D0", bgcolor="#2E3440"),
            "content.highlight": Style(color="#2E3440", bgcolor="#88C0D0"),
            
            "progress.bar": Style(color="#D8DEE9"),
            "progress.text": Style(color="#E5E9F0"),
            "progress.percentage": Style(color="#8FBCBB"),
            
            "bookshelf.title": Style(color="#D8DEE9", bold=True),
            "bookshelf.author": Style(color="#E5E9F0"),
            "bookshelf.progress": Style(color="#5E81AC"),
            "bookshelf.tag": Style(color="#A3BE8C", bgcolor="#3B4252"),
            "bookshelf.selected": Style(bgcolor="#434C5E"),
            
            "reader.text": Style(color="#E5E9F0"),
            "reader.chapter": Style(color="#D8DEE9", bold=True),
            "reader.page_number": Style(color="#4C566A"),
            "reader.bookmark": Style(color="#88C0D0"),
            "reader.search_result": Style(color="#2E3440", bgcolor="#88C0D0"),
        }

        # 巧克力咖啡主题
        self.themes["chocolate-coffee"] = {
            "app.title": Style(color="#6F4E37", bold=True),
            "app.subtitle": Style(color="#8D6E63"),
            "app.accent": Style(color="#A1887F"),
            "app.highlight": Style(color="#BCAAA4"),
            "app.warning": Style(color="#FFB74D"),
            "app.success": Style(color="#81C784"),
            "app.info": Style(color="#64B5F6"),
            "app.muted": Style(color="#5D4037"),
            
            "ui.border": Style(color="#A1887F"),
            "ui.background": Style(bgcolor="#3E2723"),
            "ui.panel": Style(bgcolor="#4E342E"),
            "ui.panel.title": Style(color="#6F4E37", bold=True),
            "ui.label": Style(color="#8D6E63"),
            "ui.button": Style(color="#FFFFFF", bgcolor="#6F4E37"),
            "ui.button.primary": Style(color="#FFFFFF", bgcolor="#A1887F"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#81C784"),
            "ui.button.warning": Style(color="#3E2723", bgcolor="#FFB74D"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#E57373"),
            "ui.input": Style(color="#8D6E63", bgcolor="#4E342E"),
            "ui.input.focus": Style(color="#A1887F", bgcolor="#5D4037"),
            "ui.selection": Style(bgcolor="#5D4037"),
            
            "content.text": Style(color="#8D6E63"),
            "content.heading": Style(color="#6F4E37", bold=True),
            "content.subheading": Style(color="#A1887F", bold=True),
            "content.link": Style(color="#64B5F6", underline=True),
            "content.quote": Style(color="#81C784", italic=True),
            "content.code": Style(color="#BCAAA4", bgcolor="#3E2723"),
            "content.highlight": Style(color="#3E2723", bgcolor="#BCAAA4"),
            
            "progress.bar": Style(color="#6F4E37"),
            "progress.text": Style(color="#8D6E63"),
            "progress.percentage": Style(color="#A1887F"),
            
            "bookshelf.title": Style(color="#6F4E37", bold=True),
            "bookshelf.author": Style(color="#8D6E63"),
            "bookshelf.progress": Style(color="#64B5F6"),
            "bookshelf.tag": Style(color="#81C784", bgcolor="#4E342E"),
            "bookshelf.selected": Style(bgcolor="#5D4037"),
            
            "reader.text": Style(color="#8D6E63"),
            "reader.chapter": Style(color="#6F4E37", bold=True),
            "reader.page_number": Style(color="#5D4037"),
            "reader.bookmark": Style(color="#BCAAA4"),
            "reader.search_result": Style(color="#3E2723", bgcolor="#BCAAA4"),
        }

        # 极光主题
        self.themes["aurora-borealis"] = {
            "app.title": Style(color="#00E5FF", bold=True),
            "app.subtitle": Style(color="#00BCD4"),
            "app.accent": Style(color="#40C4FF"),
            "app.highlight": Style(color="#84FFFF"),
            "app.warning": Style(color="#FFB74D"),
            "app.success": Style(color="#69F0AE"),
            "app.info": Style(color="#82B1FF"),
            "app.muted": Style(color="#00ACC1"),
            
            "ui.border": Style(color="#40C4FF"),
            "ui.background": Style(bgcolor="#0D47A1"),
            "ui.panel": Style(bgcolor="#1565C0"),
            "ui.panel.title": Style(color="#00E5FF", bold=True),
            "ui.label": Style(color="#00BCD4"),
            "ui.button": Style(color="#0D47A1", bgcolor="#00E5FF"),
            "ui.button.primary": Style(color="#0D47A1", bgcolor="#40C4FF"),
            "ui.button.success": Style(color="#0D47A1", bgcolor="#69F0AE"),
            "ui.button.warning": Style(color="#0D47A1", bgcolor="#FFB74D"),
            "ui.button.danger": Style(color="#FFFFFF", bgcolor="#FF5252"),
            "ui.input": Style(color="#00BCD4", bgcolor="#1565C0"),
            "ui.input.focus": Style(color="#00E5FF", bgcolor="#1976D2"),
            "ui.selection": Style(bgcolor="#1976D2"),
            
            "content.text": Style(color="#00BCD4"),
            "content.heading": Style(color="#00E5FF", bold=True),
            "content.subheading": Style(color="#40C4FF", bold=True),
            "content.link": Style(color="#82B1FF", underline=True),
            "content.quote": Style(color="#69F0AE", italic=True),
            "content.code": Style(color="#84FFFF", bgcolor="#0D47A1"),
            "content.highlight": Style(color="#0D47A1", bgcolor="#84FFFF"),
            
            "progress.bar": Style(color="#00E5FF"),
            "progress.text": Style(color="#00BCD4"),
            "progress.percentage": Style(color="#40C4FF"),
            
            "bookshelf.title": Style(color="#00E5FF", bold=True),
            "bookshelf.author": Style(color="#00BCD4"),
            "bookshelf.progress": Style(color="#82B1FF"),
            "bookshelf.tag": Style(color="#69F0AE", bgcolor="#1565C0"),
            "bookshelf.selected": Style(bgcolor="#1976D2"),
            
            "reader.text": Style(color="#00BCD4"),
            "reader.chapter": Style(color="#00E5FF", bold=True),
            "reader.page_number": Style(color="#00ACC1"),
            "reader.bookmark": Style(color="#84FFFF"),
            "reader.search_result": Style(color="#0D47A1", bgcolor="#84FFFF"),
        }

        # 沙漠绿洲主题
        self.themes["desert-oasis"] = {
            "app.title": Style(color="#FFF3E0", bold=True),
            "app.subtitle": Style(color="#FFE0B2"),
            "app.accent": Style(color="#FFCC80"),
            "app.highlight": Style(color="#FFE082"),
            "app.warning": Style(color="#FF8A65"),
            "app.success": Style(color="#81C784"),
            "app.info": Style(color="#64B5F6"),
            "app.muted": Style(color="#FFB74D"),
            
            "ui.border": Style(color="#FFCC80"),
            "ui.background": Style(bgcolor="#5D4037"),
            "ui.panel": Style(bgcolor="#6D4C41"),
            "ui.panel.title": Style(color="#FFF3E0", bold=True),
            "ui.label": Style(color="#FFE0B2"),
            "ui.button": Style(color="#5D4037", bgcolor="#FFF3E0"),
            "ui.button.primary": Style(color="#5D4037", bgcolor="#FFCC80"),
            "ui.button.success": Style(color="#5D4037", bgcolor="#81C784"),
            "ui.button.warning": Style(color="#5D4037", bgcolor="#FF8A65"),
            "ui.button.danger": Style(color="#FFF3E0", bgcolor="#E57373"),
            "ui.input": Style(color="#FFE0B2", bgcolor="#6D4C41"),
            "ui.input.focus": Style(color="#FFF3E0", bgcolor="#795548"),
            "ui.selection": Style(bgcolor="#795548"),
            
            "content.text": Style(color="#FFE0B2"),
            "content.heading": Style(color="#FFF3E0", bold=True),
            "content.subheading": Style(color="#FFCC80", bold=True),
            "content.link": Style(color="#64B5F6", underline=True),
            "content.quote": Style(color="#81C784", italic=True),
            "content.code": Style(color="#FFE082", bgcolor="#5D4037"),
            "content.highlight": Style(color="#5D4037", bgcolor="#FFE082"),
            
            "progress.bar": Style(color="#FFF3E0"),
            "progress.text": Style(color="#FFE0B2"),
            "progress.percentage": Style(color="#FFCC80"),
            
            "bookshelf.title": Style(color="#FFF3E0", bold=True),
            "bookshelf.author": Style(color="#FFE0B2"),
            "bookshelf.progress": Style(color="#64B5F6"),
            "bookshelf.tag": Style(color="#81C784", bgcolor="#6D4C41"),
            "bookshelf.selected": Style(bgcolor="#795548"),
            
            "reader.text": Style(color="#FFE0B2"),
            "reader.chapter": Style(color="#FFF3E0", bold=True),
            "reader.page_number": Style(color="#FFB74D"),
            "reader.bookmark": Style(color="#FFE082"),
            "reader.search_result": Style(color="#5D4037", bgcolor="#FFE082"),
        }

        # 黑曜石主题
        self.themes["obsidian-stone"] = {
            "app.title": Style(color="#B0BEC5", bold=True),
            "app.subtitle": Style(color="#CFD8DC"),
            "app.accent": Style(color="#E0E0E0"),
            "app.highlight": Style(color="#F5F5F5"),
            "app.warning": Style(color="#FF8A65"),
            "app.success": Style(color="#81C784"),
            "app.info": Style(color="#64B5F6"),
            "app.muted": Style(color="#90A4AE"),
            
            "ui.border": Style(color="#E0E0E0"),
            "ui.background": Style(bgcolor="#263238"),
            "ui.panel": Style(bgcolor="#37474F"),
            "ui.panel.title": Style(color="#B0BEC5", bold=True),
            "ui.label": Style(color="#CFD8DC"),
            "ui.button": Style(color="#263238", bgcolor="#B0BEC5"),
            "ui.button.primary": Style(color="#263238", bgcolor="#E0E0E0"),
            "ui.button.success": Style(color="#263238", bgcolor="#81C784"),
            "ui.button.warning": Style(color="#263238", bgcolor="#FF8A65"),
            "ui.button.danger": Style(color="#F5F5F5", bgcolor="#E57373"),
            "ui.input": Style(color="#CFD8DC", bgcolor="#37474F"),
            "ui.input.focus": Style(color="#E0E0E0", bgcolor="#455A64"),
            "ui.selection": Style(bgcolor="#455A64"),
            
            "content.text": Style(color="#CFD8DC"),
            "content.heading": Style(color="#B0BEC5", bold=True),
            "content.subheading": Style(color="#E0E0E0", bold=True),
            "content.link": Style(color="#64B5F6", underline=True),
            "content.quote": Style(color="#81C784", italic=True),
            "content.code": Style(color="#F5F5F5", bgcolor="#263238"),
            "content.highlight": Style(color="#263238", bgcolor="#F5F5F5"),
            
            "progress.bar": Style(color="#B0BEC5"),
            "progress.text": Style(color="#CFD8DC"),
            "progress.percentage": Style(color="#E0E0E0"),
            
            "bookshelf.title": Style(color="#B0BEC5", bold=True),
            "bookshelf.author": Style(color="#CFD8DC"),
            "bookshelf.progress": Style(color="#64B5F6"),
            "bookshelf.tag": Style(color="#81C784", bgcolor="#37474F"),
            "bookshelf.selected": Style(bgcolor="#455A64"),
            
            "reader.text": Style(color="#CFD8DC"),
            "reader.chapter": Style(color="#B0BEC5", bold=True),
            "reader.page_number": Style(color="#90A4AE"),
            "reader.bookmark": Style(color="#F5F5F5"),
            "reader.search_result": Style(color="#263238", bgcolor="#F5F5F5"),
        }

        # 熔岩主题
        self.themes["molten-lava"] = {
            "app.title": Style(color="#FFEB3B", bold=True),
            "app.subtitle": Style(color="#FFC107"),
            "app.accent": Style(color="#FF9800"),
            "app.highlight": Style(color="#FF5722"),
            "app.warning": Style(color="#F44336"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#FF6F00"),
            
            "ui.border": Style(color="#FF9800"),
            "ui.background": Style(bgcolor="#3E2723"),
            "ui.panel": Style(bgcolor="#4E342E"),
            "ui.panel.title": Style(color="#FFEB3B", bold=True),
            "ui.label": Style(color="#FFC107"),
            "ui.button": Style(color="#3E2723", bgcolor="#FFEB3B"),
            "ui.button.primary": Style(color="#3E2723", bgcolor="#FF9800"),
            "ui.button.success": Style(color="#3E2723", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#3E2723", bgcolor="#FF5722"),
            "ui.button.danger": Style(color="#FFEB3B", bgcolor="#F44336"),
            "ui.input": Style(color="#FFC107", bgcolor="#4E342E"),
            "ui.input.focus": Style(color="#FFEB3B", bgcolor="#5D4037"),
            "ui.selection": Style(bgcolor="#5D4037"),
            
            "content.text": Style(color="#FFC107"),
            "content.heading": Style(color="#FFEB3B", bold=True),
            "content.subheading": Style(color="#FF9800", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#FF5722", bgcolor="#3E2723"),
            "content.highlight": Style(color="#3E2723", bgcolor="#FF5722"),
            
            "progress.bar": Style(color="#FFEB3B"),
            "progress.text": Style(color="#FFC107"),
            "progress.percentage": Style(color="#FF9800"),
            
            "bookshelf.title": Style(color="#FFEB3B", bold=True),
            "bookshelf.author": Style(color="#FFC107"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#4E342E"),
            "bookshelf.selected": Style(bgcolor="#5D4037"),
            
            "reader.text": Style(color="#FFC107"),
            "reader.chapter": Style(color="#FFEB3B", bold=True),
            "reader.page_number": Style(color="#FF6F00"),
            "reader.bookmark": Style(color="#FF5722"),
            "reader.search_result": Style(color="#3E2723", bgcolor="#FF5722"),
        }

        # 粉红樱花主题
        self.themes["sakura-pink"] = {
            "app.title": Style(color="#F8BBD0", bold=True),
            "app.subtitle": Style(color="#F48FB1"),
            "app.accent": Style(color="#F06292"),
            "app.highlight": Style(color="#E91E63"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#C2185B"),
            
            "ui.border": Style(color="#F06292"),
            "ui.background": Style(bgcolor="#880E4F"),
            "ui.panel": Style(bgcolor="#AD1457"),
            "ui.panel.title": Style(color="#F8BBD0", bold=True),
            "ui.label": Style(color="#F48FB1"),
            "ui.button": Style(color="#880E4F", bgcolor="#F8BBD0"),
            "ui.button.primary": Style(color="#880E4F", bgcolor="#F06292"),
            "ui.button.success": Style(color="#880E4F", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#880E4F", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#F8BBD0", bgcolor="#E57373"),
            "ui.input": Style(color="#F48FB1", bgcolor="#AD1457"),
            "ui.input.focus": Style(color="#F8BBD0", bgcolor="#C2185B"),
            "ui.selection": Style(bgcolor="#C2185B"),
            
            "content.text": Style(color="#F48FB1"),
            "content.heading": Style(color="#F8BBD0", bold=True),
            "content.subheading": Style(color="#F06292", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#E91E63", bgcolor="#880E4F"),
            "content.highlight": Style(color="#880E4F", bgcolor="#E91E63"),
            
            "progress.bar": Style(color="#F8BBD0"),
            "progress.text": Style(color="#F48FB1"),
            "progress.percentage": Style(color="#F06292"),
            
            "bookshelf.title": Style(color="#F8BBD0", bold=True),
            "bookshelf.author": Style(color="#F48FB1"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#AD1457"),
            "bookshelf.selected": Style(bgcolor="#C2185B"),
            
            "reader.text": Style(color="#F48FB1"),
            "reader.chapter": Style(color="#F8BBD0", bold=True),
            "reader.page_number": Style(color="#C2185B"),
            "reader.bookmark": Style(color="#E91E63"),
            "reader.search_result": Style(color="#880E4F", bgcolor="#E91E63"),
        }

        # 冰川蓝主题
        self.themes["glacier-blue"] = {
            "app.title": Style(color="#E1F5FE", bold=True),
            "app.subtitle": Style(color="#B3E5FC"),
            "app.accent": Style(color="#81D4FA"),
            "app.highlight": Style(color="#4FC3F7"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#0288D1"),
            
            "ui.border": Style(color="#81D4FA"),
            "ui.background": Style(bgcolor="#01579B"),
            "ui.panel": Style(bgcolor="#0277BD"),
            "ui.panel.title": Style(color="#E1F5FE", bold=True),
            "ui.label": Style(color="#B3E5FC"),
            "ui.button": Style(color="#01579B", bgcolor="#E1F5FE"),
            "ui.button.primary": Style(color="#01579B", bgcolor="#81D4FA"),
            "ui.button.success": Style(color="#01579B", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#01579B", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#E1F5FE", bgcolor="#E57373"),
            "ui.input": Style(color="#B3E5FC", bgcolor="#0277BD"),
            "ui.input.focus": Style(color="#E1F5FE", bgcolor="#0288D1"),
            "ui.selection": Style(bgcolor="#0288D1"),
            
            "content.text": Style(color="#B3E5FC"),
            "content.heading": Style(color="#E1F5FE", bold=True),
            "content.subheading": Style(color="#81D4FA", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#4FC3F7", bgcolor="#01579B"),
            "content.highlight": Style(color="#01579B", bgcolor="#4FC3F7"),
            
            "progress.bar": Style(color="#E1F5FE"),
            "progress.text": Style(color="#B3E5FC"),
            "progress.percentage": Style(color="#81D4FA"),
            
            "bookshelf.title": Style(color="#E1F5FE", bold=True),
            "bookshelf.author": Style(color="#B3E5FC"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#0277BD"),
            "bookshelf.selected": Style(bgcolor="#0288D1"),
            
            "reader.text": Style(color="#B3E5FC"),
            "reader.chapter": Style(color="#E1F5FE", bold=True),
            "reader.page_number": Style(color="#0288D1"),
            "reader.bookmark": Style(color="#4FC3F7"),
            "reader.search_result": Style(color="#01579B", bgcolor="#4FC3F7"),
        }

        # 紫水晶主题
        self.themes["amethyst-crystal"] = {
            "app.title": Style(color="#E1BEE7", bold=True),
            "app.subtitle": Style(color="#CE93D8"),
            "app.accent": Style(color="#BA68C8"),
            "app.highlight": Style(color="#AB47BC"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            ...
            "ui.border": Style(color="#BA68C8"),
            "ui.background": Style(bgcolor="#4A148C"),
            "ui.panel": Style(bgcolor="#6A1B9A"),
            "ui.panel.title": Style(color="#E1BEE7", bold=True),
            "ui.label": Style(color="#CE93D8"),
            "ui.button": Style(color="#4A148C", bgcolor="#E1BEE7"),
            "ui.button.primary": Style(color="#4A148C", bgcolor="#BA68C8"),
            "ui.button.success": Style(color="#4A148C", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#4A148C", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#E1BEE7", bgcolor="#E57373"),
            "ui.input": Style(color="#CE93D8", bgcolor="#6A1B9A"),
            "ui.input.focus": Style(color="#E1BEE7", bgcolor="#8E24AA"),
            "ui.selection": Style(bgcolor="#8E24AA"),
            
            "content.text": Style(color="#CE93D8"),
            "content.heading": Style(color="#E1BEE7", bold=True),
            "content.subheading": Style(color="#BA68C8", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#AB47BC", bgcolor="#4A148C"),
            "content.highlight": Style(color="#4A148C", bgcolor="#AB47BC"),
            
            "progress.bar": Style(color="#E1BEE7"),
            "progress.text": Style(color="#CE93D8"),
            "progress.percentage": Style(color="#BA68C8"),
            
            "bookshelf.title": Style(color="#E1BEE7", bold=True),
            "bookshelf.author": Style(color="#CE93D8"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#6A1B9A"),
            "bookshelf.selected": Style(bgcolor="#8E24AA"),
            
            "reader.text": Style(color="#CE93D8"),
            "reader.chapter": Style(color="#E1BEE7", bold=True),
            "reader.page_number": Style(color="#8E24AA"),
            "reader.bookmark": Style(color="#AB47BC"),
            "reader.search_result": Style(color="#4A148C", bgcolor="#AB47BC"),
        }

        # 青玉主题
        self.themes["jade-green"] = {
            "app.title": Style(color="#A5D6A7", bold=True),
            "app.subtitle": Style(color="#81C784"),
            "app.accent": Style(color="#66BB6A"),
            "app.highlight": Style(color="#4CAF50"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#2E7D32"),
            "app.info": Style(color="#2196F3"),
            ...
            "ui.border": Style(color="#66BB6A"),
            "ui.background": Style(bgcolor="#1B5E20"),
            "ui.panel": Style(bgcolor="#2E7D32"),
            "ui.panel.title": Style(color="#A5D6A7", bold=True),
            "ui.label": Style(color="#81C784"),
            "ui.button": Style(color="#1B5E20", bgcolor="#A5D6A7"),
            "ui.button.primary": Style(color="#1B5E20", bgcolor="#66BB6A"),
            "ui.button.success": Style(color="#FFFFFF", bgcolor="#2E7D32"),
            "ui.button.warning": Style(color="#1B5E20", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#A5D6A7", bgcolor="#E57373"),
            "ui.input": Style(color="#81C784", bgcolor="#2E7D32"),
            "ui.input.focus": Style(color="#A5D6A7", bgcolor="#388E3C"),
            "ui.selection": Style(bgcolor="#388E3C"),
            
            "content.text": Style(color="#81C784"),
            "content.heading": Style(color="#A5D6A7", bold=True),
            "content.subheading": Style(color="#66BB6A", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#2E7D32", italic=True),
            "content.code": Style(color="#4CAF50", bgcolor="#1B5E20"),
            "content.highlight": Style(color="#1B5E20", bgcolor="#4CAF50"),
            
            "progress.bar": Style(color="#A5D6A7"),
            "progress.text": Style(color="#81C784"),
            "progress.percentage": Style(color="#66BB6A"),
            
            "bookshelf.title": Style(color="#A5D6A7", bold=True),
            "bookshelf.author": Style(color="#81C784"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#2E7D32", bgcolor="#2E7D32"),
            "bookshelf.selected": Style(bgcolor="#388E3C"),
            
            "reader.text": Style(color="#81C784"),
            "reader.chapter": Style(color="#A5D6A7", bold=True),
            "reader.page_number": Style(color="#388E3C"),
            "reader.bookmark": Style(color="#4CAF50"),
            "reader.search_result": Style(color="#1B5E20", bgcolor="#4CAF50"),
        }

        # 黄金主题
        self.themes["golden-hour"] = {
            "app.title": Style(color="#FFD700", bold=True),
            "app.subtitle": Style(color="#FFC107"),
            "app.accent": Style(color="#FFB300"),
            "app.highlight": Style(color="#FFA000"),
            "app.warning": Style(color="#FF5722"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#FF8F00"),
            
            "ui.border": Style(color="#FFB300"),
            "ui.background": Style(bgcolor="#3E2723"),
            "ui.panel": Style(bgcolor="#4E342E"),
            "ui.panel.title": Style(color="#FFD700", bold=True),
            "ui.label": Style(color="#FFC107"),
            "ui.button": Style(color="#3E2723", bgcolor="#FFD700"),
            "ui.button.primary": Style(color="#3E2723", bgcolor="#FFB300"),
            "ui.button.success": Style(color="#3E2723", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#3E2723", bgcolor="#FFA000"),
            "ui.button.danger": Style(color="#FFD700", bgcolor="#FF5722"),
            "ui.input": Style(color="#FFC107", bgcolor="#4E342E"),
            "ui.input.focus": Style(color="#FFD700", bgcolor="#5D4037"),
            "ui.selection": Style(bgcolor="#5D4037"),
            
            "content.text": Style(color="#FFC107"),
            "content.heading": Style(color="#FFD700", bold=True),
            "content.subheading": Style(color="#FFB300", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#FFA000", bgcolor="#3E2723"),
            "content.highlight": Style(color="#3E2723", bgcolor="#FFA000"),
            
            "progress.bar": Style(color="#FFD700"),
            "progress.text": Style(color="#FFC107"),
            "progress.percentage": Style(color="#FFB300"),
            
            "bookshelf.title": Style(color="#FFD700", bold=True),
            "bookshelf.author": Style(color="#FFC107"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#4E342E"),
            "bookshelf.selected": Style(bgcolor="#5D4037"),
            ...
            "reader.text": Style(color="#FFC107"),
            "reader.chapter": Style(color="#FFD700", bold=True),
            "reader.page_number": Style(color="#FF8F00"),
            "reader.bookmark": Style(color="#FFA000"),
            "reader.search_result": Style(color="#3E2723", bgcolor="#FFA000"),
        }

        # 银河系主题
        self.themes["milky-way"] = {
            "app.title": Style(color="#E8EAF6", bold=True),
            "app.subtitle": Style(color="#C5CAE9"),
            "app.accent": Style(color="#9FA8DA"),
            "app.highlight": Style(color="#7986CB"),
            "app.warning": Style(color="#FF9800"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#5C6BC0"),
            
            "ui.border": Style(color="#9FA8DA"),
            "ui.background": Style(bgcolor="#1A237E"),
            "ui.panel": Style(bgcolor="#283593"),
            "ui.panel.title": Style(color="#E8EAF6", bold=True),
            "ui.label": Style(color="#C5CAE9"),
            "ui.button": Style(color="#1A237E", bgcolor="#E8EAF6"),
            "ui.button.primary": Style(color="#1A237E", bgcolor="#9FA8DA"),
            "ui.button.success": Style(color="#1A237E", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#1A237E", bgcolor="#FF9800"),
            "ui.button.danger": Style(color="#E8EAF6", bgcolor="#E57373"),
            "ui.input": Style(color="#C5CAE9", bgcolor="#283593"),
            "ui.input.focus": Style(color="#E8EAF6", bgcolor="#3949AB"),
            "ui.selection": Style(bgcolor="#3949AB"),
            
            "content.text": Style(color="#C5CAE9"),
            "content.heading": Style(color="#E8EAF6", bold=True),
            "content.subheading": Style(color="#9FA8DA", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#7986CB", bgcolor="#1A237E"),
            "content.highlight": Style(color="#1A237E", bgcolor="#7986CB"),
            
            "progress.bar": Style(color="#E8EAF6"),
            "progress.text": Style(color="#C5CAE9"),
            "progress.percentage": Style(color="#9FA8DA"),
            
            "bookshelf.title": Style(color="#E8EAF6", bold=True),
            "bookshelf.author": Style(color="#C5CAE9"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#283593"),
            "bookshelf.selected": Style(bgcolor="#3949AB"),
            
            "reader.text": Style(color="#C5CAE9"),
            "reader.chapter": Style(color="#E8EAF6", bold=True),
            "reader.page_number": Style(color="#5C6BC0"),
            "reader.bookmark": Style(color="#7986CB"),
            "reader.search_result": Style(color="#1A237E", bgcolor="#7986CB"),
        }

        # 珊瑚礁主题
        self.themes["coral-reef-2"] = {
            "app.title": Style(color="#FFAB91", bold=True),
            "app.subtitle": Style(color="#FF8A65"),
            "app.accent": Style(color="#FF7043"),
            "app.highlight": Style(color="#FF5722"),
            "app.warning": Style(color="#F44336"),
            "app.success": Style(color="#4CAF50"),
            "app.info": Style(color="#2196F3"),
            "app.muted": Style(color="#FF5722"),
            
            "ui.border": Style(color="#FF7043"),
            "ui.background": Style(bgcolor="#BF360C"),
            "ui.panel": Style(bgcolor="#D84315"),
            "ui.panel.title": Style(color="#FFAB91", bold=True),
            "ui.label": Style(color="#FF8A65"),
            "ui.button": Style(color="#BF360C", bgcolor="#FFAB91"),
            "ui.button.primary": Style(color="#BF360C", bgcolor="#FF7043"),
            "ui.button.success": Style(color="#BF360C", bgcolor="#4CAF50"),
            "ui.button.warning": Style(color="#FFAB91", bgcolor="#FF5722"),
            "ui.button.danger": Style(color="#FFAB91", bgcolor="#F44336"),
            "ui.input": Style(color="#FF8A65", bgcolor="#D84315"),
            "ui.input.focus": Style(color="#FFAB91", bgcolor="#E64A19"),
            "ui.selection": Style(bgcolor="#E64A19"),
            
            "content.text": Style(color="#FF8A65"),
            "content.heading": Style(color="#FFAB91", bold=True),
            "content.subheading": Style(color="#FF7043", bold=True),
            "content.link": Style(color="#2196F3", underline=True),
            "content.quote": Style(color="#4CAF50", italic=True),
            "content.code": Style(color="#FF5722", bgcolor="#BF360C"),
            "content.highlight": Style(color="#BF360C", bgcolor="#FF5722"),
            
            "progress.bar": Style(color="#FFAB91"),
            "progress.text": Style(color="#FF8A65"),
            "progress.percentage": Style(color="#FF7043"),
            
            "bookshelf.title": Style(color="#FFAB91", bold=True),
            "bookshelf.author": Style(color="#FF8A65"),
            "bookshelf.progress": Style(color="#2196F3"),
            "bookshelf.tag": Style(color="#4CAF50", bgcolor="#D84315"),
            "bookshelf.selected": Style(bgcolor="#E64A19"),
            
            "reader.text": Style(color="#FF8A65"),
            "reader.chapter": Style(color="#FFAB91", bold=True),
            "reader.page_number": Style(color="#FF5722"),
            "reader.bookmark": Style(color="#FF5722"),
            "reader.search_result": Style(color="#BF360C", bgcolor="#FF5722"),
        }

        # 森林晨雾主题
        self.themes["forest-mist"] = {
            "app.title": Style(color="#DCEDC8", bold=True),
            "app.subtitle": Style(color="#C5E1A5"),
            "app.accent": Style(color="#AED581"),
            "app.highlight": Style(color="#9CCC65"),
            "app.warning": Style(color="#FFB74D"),
            "app.success": Style(color="#66BB6A"),
            "app.info": Style(color="#64B5F6"),
            "app.muted": Style(color="#8BC34A"),
            
            "ui.border": Style(color="#AED581"),
            "ui.background": Style(bgcolor="#1B5E20"),
            "ui.panel": Style(bgcolor="#2E7D32"),
            "ui.panel.title": Style(color="#DCEDC8", bold=True),
            "ui.label": Style(color="#C5E1A5"),
            "ui.button": Style(color="#1B5E20", bgcolor="#DCEDC8"),
            "ui.button.primary": Style(color="#1B5E20", bgcolor="#AED581"),
            "ui.button.success": Style(color="#1B5E20", bgcolor="#66BB6A"),
            "ui.button.warning": Style(color="#1B5E20", bgcolor="#FFB74D"),
            "ui.button.danger": Style(color="#DCEDC8", bgcolor="#E57373"),
            "ui.input": Style(color="#C5E1A5", bgcolor="#2E7D32"),
            "ui.input.focus": Style(color="#DCEDC8", bgcolor="#388E3C"),
            "ui.selection": Style(bgcolor="#388E3C"),
            
            "content.text": Style(color="#C5E1A5"),
            "content.heading": Style(color="#DCEDC8", bold=True),
            "content.subheading": Style(color="#AED581", bold=True),
            "content.link": Style(color="#64B5F6", underline=True),
            "content.quote": Style(color="#66BB6A", italic=True),
            "content.code": Style(color="#9CCC65", bgcolor="#1B5E20"),
            "content.highlight": Style(color="#1B5E20", bgcolor="#9CCC65"),
            
            "progress.bar": Style(color="#DCEDC8"),
            "progress.text": Style(color="#C5E1A5"),
            "progress.percentage": Style(color="#AED581"),
            
            "bookshelf.title": Style(color="#DCEDC8", bold=True),
            "bookshelf.author": Style(color="#C5E1A5"),
            "bookshelf.progress": Style(color="#64B5F6"),
            "bookshelf.tag": Style(color="#66BB6A", bgcolor="#2E7D32"),
            "bookshelf.selected": Style(bgcolor="#388E3C"),
            
            "reader.text": Style(color="#C5E1A5"),
            "reader.chapter": Style(color="#DCEDC8", bold=True),
            "reader.page_number": Style(color="#8BC34A"),
            "reader.bookmark": Style(color="#9CCC65"),
            "reader.search_result": Style(color="#1B5E20", bgcolor="#9CCC65"),
        }
