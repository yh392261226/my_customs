...
class DatabaseManager:
    ...
    def _init_database(self) -> None:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            novel_sites_data = [
                ('人妻小说网', 'https://www.renqixiaoshuo.net', '~/Documents/novels/datas', 1, 1, 'renqixiaoshuo_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('龙腾小说网', 'https://www.87nb.com', '~/Documents/novels/datas', 1, 1, '87nb_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('91PORNA', 'https://91porna.com/novels/new', '~/Documents/novels/datas', 1, 1, '91porna_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345678901'),
                ('AAA成人小說', 'https://aaanovel.com', '~/Documents/novels/datas/', 0, 0, 'aaanovel_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '2025/11/05/小说名'),
                ('色情小说网', 'https://www.book18.me', '~/Documents/novels/datas/', 0, 0, 'book18_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '书籍名(长篇)或12345(短篇)'),
                ('禁忌书屋', 'https://www.cool18.com/bbs4/index.php', '~/Documents/novels/datas/', 0, 1, 'cool18_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345678'),
                ('成人小说网', 'https://crxs.me', '~/Documents/novels/datas/', 0, 0, 'crxs_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '5fd28afaf29d8'),
                ('风月文学网', 'http://www.h528.com', '~/Documents/novels/datas/', 0, 1, 'h528_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('色情001', 'https://seqing001.com', '~/Documents/novels/datas/', 0, 1, 'seqing001_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '1234'),
                ('中文成人文學網', 'https://blog.xbookcn.com', '~/Documents/novels/datas/', 0, 0, 'xbookcn_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '2022/01/blog-post_30'),
                ('小黄书XCHINA', 'http://xchina.co/', '~/Documents/novels/datas/', 0, 0, 'xchina_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), ''),
                ('69文学网', 'https://www.69hnovel.com/erotic-novel.html', '~/Documents/novels/datas/', 0, 0, '69hnovel_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), 'anime/article-8629'),
                ('TXTXi', 'https://www.txtxi.com/', '~/Documents/novels/datas/', 0, 1, 'txtxi_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('不雅污书', 'https://www.buya6.xyz/', '~/Documents/novels/datas/', 0, 1, 'buya6_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('撸撸色书', 'https://www.lulu6.xyz/', '~/Documents/novels/datas/', 0, 1, 'lulu6_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('AA阅读', 'https://aaread.cc/', '~/Documents/novels/datas/', 0, 1, 'aaread_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('都市小说网', 'https://comcom.cyou/', '~/Documents/novels/datas/', 0, 1, 'comcom_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('肉肉阅读', 'https://xxread.net/', '~/Documents/novels/datas/', 0, 1, 'xxread_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('夜色书阁', 'http://5l15cquy.yssg2.cfd/', '~/Documents/novels/datas/', 0, 1, 'yssg_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('咪咕文学', 'https://74qyavudmbzu1.migu1.top/', '~/Documents/novels/datas/', 0, 1, 'migu_v2', '🔞成人', 2, datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('狐狸小说网', 'https://a.huli1.cfd', '~/Documents/novels/datas/', '0', '1', 'huli_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('XX小说网', 'https://xbookasd.top/', '~/Documents/novels/datas/', '0', '0', 'xbookasd_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), 'ambmwnKgMYHR1Z'),
                ('骚洞小说网', 'https://www.sdxs.xyz/', '~/Documents/novels/datas/', '0', '1', 'sdxs_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('污X小说网', 'https://www.wux3.xyz/', '~/Documents/novels/datas/', '0', '1', 'wux3_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('污污污书', 'https://www.wushu5.xyz/', '~/Documents/novels/datas/', '0', '1', 'wushu5_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('色污骚文', 'https://www.sewu3.xyz/', '~/Documents/novels/datas/', '0', '1', 'sewu3_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('啪啪色文', 'https://www.pa33.xyz/', '~/Documents/novels/datas/', '0', '1', 'pa33_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('泄火小说网', 'https://www.xhxs2.xyz/', '~/Documents/novels/datas/', '0', '1', 'xhxs2_v2', '🔞成人', '0', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('渣女读书', 'https://www.zhanv9.xyz/', '~/Documents/novels/datas/', '0', '1', 'zhanv9_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('撸色书吧', 'https://www.luseshuba2.xyz/', '~/Documents/novels/datas/', '0', '1', 'luseshuba2_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('性侣文库', 'https://www.wen2.xyz/', '~/Documents/novels/datas/', '0', '1', 'wen2_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '123456'),
                ('黄桃书屋', 'https://www.photo-gram.com/', '~/Documents/novels/datas/', '0', '1', 'photo_gram_v2', '🔞成人', '3', datetime.now().isoformat(), datetime.now().isoformat(), 'abcde'),
                ('风情小说', 'https://fq.zhufuaini.top/', '~/Documents/novels/datas/', '0', '1', 'fqzhufuaini_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('色情小说', 'https://sq.ranjing-cc.club/', '~/Documents/novels/datas/', '0', '1', 'sqranjing_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('18禁成人小说', 'https://www.auate.icu/', '~/Documents/novels/datas/', '0', '1', 'auate_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('18文学', 'https://www.po18.in/', '~/Documents/novels/datas/', '1', '1', 'po18_v2', '🔞成人', '3', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('四月过往', 'https://m.lllhhhgroup.cfd/', '~/Documents/novels/datas/', '0', '1', 'lllhhhgroup_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('健康小说', 'https://w.jiankangxs.mom/', '~/Documents/novels/datas/', '0', '1', 'jiankangxs_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('第一说吧', 'https://a.shiyimng-gyy.click/', '~/Documents/novels/datas/', '0', '1', 'shiyimng_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('文字色诱', 'https://www.lxybwcchb.shop/', '~/Documents/novels/datas/', '0', '1', 'lxybwcchb_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('羞涩书屋', 'https://fhjz.xiusemfxs.xyz/', '~/Documents/novels/datas/', '0', '0', 'xiusemfxs_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), 'pinyin'),
                ('海角文爱', 'https://haijbookx.top/', '~/Documents/novels/datas/', '0', '1', 'haijbookx_v2', '🔞成人', '3', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
                ('欲仙阁', 'http://ye9t6x3i.yxg3.cfd/', '~/Documents/novels/datas/', '0', '1', 'ye9t6x3i_v2', '🔞成人', '2', datetime.now().isoformat(), datetime.now().isoformat(), '12345'),
