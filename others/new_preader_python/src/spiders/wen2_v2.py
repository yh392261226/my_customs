...
class Wen2Parser(BaseParser):
    """wen2.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "性侣文库"
    description = "wen2.xyz 短篇小说解析器"
    base_url = "https://vue.wen2.xyz/"
