...
class Th5Parser(BaseParser):
    """th5.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "啪啪色文"
    description = "th5.xyz 短篇小说解析器"
    base_url = "https://vue.th5.xyz/"
