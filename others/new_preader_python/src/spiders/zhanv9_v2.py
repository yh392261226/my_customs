...
class Zhanv9Parser(BaseParser):
    """zhanv9.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "渣女读书"
    description = "zhanv9.xyz 短篇小说解析器"
    base_url = "https://vue.zhanv9.xyz/"
