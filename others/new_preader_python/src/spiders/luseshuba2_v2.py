"""
luseshuba2.xyz 小说网站解析器 - 基于配置驱动版本
...
class Luseshuba2Parser(BaseParser):
    """luseshuba2.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "撸色书吧"
    description = "luseshuba2.xyz 短篇小说解析器"
    base_url = "https://vue.luseshuba2.xyz/"
    ...
    def get_novel_url(self, novel_id: str) -> str:
        """
        重写URL生成方法，适配luseshuba2.xyz的API格式
    ...
    def _detect_book_type(self, content: str) -> str:
        """
        重写书籍类型检测，luseshuba2.xyz是短篇小说网站
    ...
    def parse_novel_list(self, url: str) -> List[Dict[str, Any]]:
        """
        解析小说列表页 - luseshuba2.xyz不需要列表页解析
