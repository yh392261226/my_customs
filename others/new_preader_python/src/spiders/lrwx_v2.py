...
class SdxsParser(BaseParser):
    """lrwx.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "骚洞小说网"
    description = "lrwx.xyz 短篇小说解析器"
    base_url = "https://vue.lrwx.xyz/"
