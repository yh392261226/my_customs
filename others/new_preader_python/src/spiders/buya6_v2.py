...
class Buya6Parser(BaseParser):
    """buya6.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "不雅污书"
    description = "buya6.xyz 短篇小说解析器"
    base_url = "https://vue.buya6.xyz"
    ...
    def parse_novel_detail(self, novel_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            content_html = detail.get('src', '').strip()
