...
class Lulu6Parser(BaseParser):
    ...
    # 基本信息
    name = "撸撸色书"
    description = "lulu6.xyz 短篇小说解析器"
    base_url = "https://vue.lulu6.xyz"
