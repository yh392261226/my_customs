...
class Wux3Parser(BaseParser):
    """wux3.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "污X小说网"
    description = "wux3.xyz 短篇小说解析器"
    base_url = "https://vue.wux3.xyz/"
