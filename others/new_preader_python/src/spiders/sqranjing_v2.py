"""
SQRanjing网站解析器
支持 https://sq.ranjing-cc.club/ 网站的短篇小说解析
"""
...
class SQRanjingParser(BaseParser):
    """SQRanjing网站解析器"""
    ...
    # 基本信息
    name = "SQRanjing"
    description = "SQRanjing短篇小说解析器"
    base_url = "https://sq.ranjing-cc.club"
