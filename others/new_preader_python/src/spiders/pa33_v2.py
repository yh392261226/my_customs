...
class Pa33Parser(BaseParser):
    """pa33.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "啪啪色文"
    description = "pa33.xyz 短篇小说解析器"
    base_url = "https://vue.pa33.xyz/"
