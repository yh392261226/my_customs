"""
xchina.co 小说网站解析器 - https://xchina.co/
支持单篇和多篇小说的自动爬取
"""
...
class XchinaParser:
    ...
    def parse_novel_list(self, url: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            小说信息列表
        """
        # xchina.co是短篇小说网站，每个小说一个页面，不需要列表解析
        return []
    ...
    def _extract_novel_id_from_url(self, url: str) -> str:
        """从URL中提取小说ID"""
        # 从类似 https://xchina.co/fiction/id-68fa7dcff3de0.html 的URL中提取ID
        import re
...
if __name__ == "__main__":
    ...
    # 示例：抓取单篇小说
    try:
        novel_url = "https://xchina.co/fiction/id-68fa7dcff3de0.html"  # 单篇示例
    ...
    # 示例：抓取多篇小说
    try:
        novel_url = "https://xchina.co/fiction/id-6286950598ecd.html"  # 多篇示例
        novel_content = parser.parse_novel_detail(novel_url)
        file_path = parser.save_to_file(novel_content, "novels")
