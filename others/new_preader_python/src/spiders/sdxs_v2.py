...
class SdxsParser(BaseParser):
    ...
    # 基本信息
    name = "骚洞小说网"
    description = "sdxs.xyz 短篇小说解析器"
    base_url = "https://vue.sdxs.xyz/"
