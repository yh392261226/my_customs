"""
LXYBWCCHB书籍网站解析器
网站: https://www.lxybwcchb.shop/
书籍详情页格式: https://www.lxybwcchb.shop/index.php/art/detail/id/23408.html
"""
...
class LXYBWCCHBParser(BaseParser):
    """LXYBWCCHB书籍网站解析器"""
    ...
    def __init__(self, proxy_config: Optional[Dict[str, Any]] = None, novel_site_name: Optional[str] = None):
        ...
        self.session.headers.update({
            ...
            'Referer': 'https://www.lxybwcchb.shop/',
            'DNT': '1',
    ...
    # 解析器配置属性
    name = "LXYBWCCHB"
    description = "LXYBWCCHB书籍网站解析器，支持短篇小说爬取"
    base_url = "https://www.lxybwcchb.shop"
