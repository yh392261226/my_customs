...
class Wushu5Parser(BaseParser):
    """wushu5.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "污污污书"
    description = "wushu5.xyz 短篇小说解析器"
    base_url = "https://vue.wushu5.xyz/"
