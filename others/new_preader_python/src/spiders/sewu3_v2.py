...
class Sewu3Parser(BaseParser):
    """sewu3.xyz 小说解析器 - JSON API版本"""
    ...
    # 基本信息
    name = "色污骚文"
    description = "sewu3.xyz 短篇小说解析器"
    base_url = "https://vue.sewu3.xyz/"
