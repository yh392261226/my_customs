"""
g33reuec网站解析器
支持 https://g33reuec.yemao1.top/ 网站的短篇小说解析
"""
...
class G33reuecParser(BaseParser):
    """g33reuec网站解析器"""
    ...
    # 基本信息
    name = "g33reuec"
    description = "g33reuec短篇小说解析器"
    base_url = "https://g33reuec.yemao1.top"
    ...
    # 正则表达式配置 - 内容提取
    content_reg = [
        r'<div[^>]*class="text-content"[^>]*>\s*<div[^>]*>(.*?)</div>\s*</div>',
