...
class Sis001Parser(BaseParser):
    ...
    def parse_novel_detail_incremental(self, novel_id: str, start_url: str, title: str = None, author: str = None, start_index: int = 0) -> Dict[str, Any]:
        ...
        while current_url:
            ...
            # 提取章节标题
            chapter_title = self._extract_with_regex(chapter_content, self.title_reg) or f'第{chapter_number}章'
            ...
            # 获取下一页URL
            next_url = self._get_next_page_url(chapter_content, current_url)
