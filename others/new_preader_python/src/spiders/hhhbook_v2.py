...
class HhhBookParser(BaseParser):
    """hhhbook.com解析器 - 配置驱动版本"""
    
    # 基本信息
    name = "hhhbook.com"
    description = "hhhbook.com小说爬取解析器（支持短篇和分页类型）"
    base_url = "https://hhhbook.com"
    
    # 编码配置 - hhhbook.com使用UTF-8编码
    encoding = "utf-8"
    ...
    def _parse_content_page_links(self, content: str, base_url: str) -> List[str]:
        ...
        # 查找分页区域 - hhhbook.com使用class="pages"的p标签
    ...
    def _clean_html_content(self, content: str) -> str:
        ...
        改进版本：更好地清理hhhbook.com特有的广告和导航内容
