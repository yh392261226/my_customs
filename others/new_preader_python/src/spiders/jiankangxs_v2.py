"""
健康小说网站解析器
网站: https://w.jiankangxs.mom/
书籍详情页格式: https://w.jiankangxs.mom/index.php/art/detail/id/20337.html
"""
...
class JianKangXSParser(BaseParser):
    """健康小说网站解析器"""
    ...
    def __init__(self, proxy_config: Optional[Dict[str, Any]] = None, novel_site_name: Optional[str] = None):
        ...
        self.session.headers.update({
            ...
            'Referer': 'https://w.jiankangxs.mom/',
            'DNT': '1',
    ...
    # 解析器配置属性
    name = "健康小说"
    description = "健康小说网站解析器，支持短篇小说爬取"
    base_url = "https://w.jiankangxs.mom"
