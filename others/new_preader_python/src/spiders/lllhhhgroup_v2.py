"""
LLLHHHGroup书籍网站解析器
网站: https://m.lllhhhgroup.cfd/
书籍详情页格式: https://m.lllhhhgroup.cfd/index.php/art/detail/id/20337.html
"""
...
class LLLHHHGroupParser(BaseParser):
    """LLLHHHGroup书籍网站解析器"""
    ...
    def __init__(self, proxy_config: Optional[Dict[str, Any]] = None, novel_site_name: Optional[str] = None):
        ...
        self.session.headers.update({
            ...
            'Referer': 'https://m.lllhhhgroup.cfd/',
            'DNT': '1',
    ...
    # 解析器配置属性
    name = "LLLHHHGroup"
    description = "LLLHHHGroup书籍网站解析器，支持短篇小说爬取"
    base_url = "https://m.lllhhhgroup.cfd"
    ...
    def _parse_single_chapter_novel(self, content: str, novel_url: str, title: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'novel_id': novel_url.split('/')[-1].replace('.html', ''),
            'url': novel_url,
            'chapters': [{
                'chapter_number': 1,
                'title': title,
