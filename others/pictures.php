...
class Pic {
    ...
    private $prepage;
    private $nextpage;
    private $currentpagefile='/Users/json/.runtime/tools/current_picture';
    private $currentnamefile='/Users/json/.runtime/tools/current_picturename';
    ...
    public function getFileLists() {
        ...
        while(($file=readdir($handler)) !== false) {
            if(is_file($this->filedir.'/'.$file) && (end(explode('.', $file))) == $this->ext) {
...
$MYRUNTIME='/Users/json/.runtime/pictures';
$pic = new Pic();
