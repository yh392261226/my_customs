...
command -v brew >/dev/null 2>&1 || echo "You don't have brew command ... You can install it by :/usr/bin/ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install)"
"
